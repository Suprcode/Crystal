...
public enum Monster : ushort
{
    ...
    Kirin = 376, // Done AI-154
    Guard3 = 377,
    ArcherGuard3 = 378,
    Bunny2 = 379,
    FrozenMiner = 380,// Done AI-155
    FrozenAxeman = 381,// Done AI-156
    FrozenMagician = 382,// Done AI-157
    SnowYeti = 383,// Done AI-158
    IceCrystalSoldier = 384,//Done AI-159
    DarkWraith = 385,//Done AI-160
    DarkSpirit = 386,
    CrystalBeast = 387,
    RedOrb = 388,
    BlueOrb = 389,
