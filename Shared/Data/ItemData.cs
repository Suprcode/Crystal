...
namespace Shared.Data {
    public class ItemInfo {
        ...
        public bool IsConsumable => Type == ItemType.Potion || Type == ItemType.Scroll || Type == ItemType.Food ||
                                    Type == ItemType.Transform || Type == ItemType.Script ||
                                    Type == ItemType.SealedHero;
    ...
    public class UserItem {
        ...
        public Awake Awake = new();

        public Stats AddedStats;

        public bool IsAdded => AddedStats.Count > 0 || Slots.Length > Info.Slots;

        public int Weight => Info.Type == ItemType.Amulet ? Info.Weight : Info.Weight * Count;
        ...
        public void SetSlotSize(int? size = null) {
            ...
            if(size != null && size == Slots.Length) {
                return;
            }

            if(size == null && Info != null && Info.Slots == Slots.Length) {
                return;
            }
    ...
    public class Awake {
        ...
        public static List<List<byte>[]> AwakeMaterials = new();

        public AwakeType Type = AwakeType.None;
        private readonly List<byte> listAwake = new();
    ...
    public class ItemRentalInformation {
        ...
        public ItemRentalInformation(BinaryReader reader, int version = int.MaxValue,
                                     int customVersion = int.MaxValue) {
    ...
    public class ItemSets {
        ...
        public byte Count;
        public bool SetComplete => Count >= Amount;
    }
    ...
    public class RandomItemStat {
        ...
        public byte MagicResistChance,
            MagicResistStatChance,
            MagicResistMaxStat,
            PoisonResistChance,
            PoisonResistStatChance,
            PoisonResistMaxStat;

        public byte HpRecovChance,
            HpRecovStatChance,
            HpRecovMaxStat,
            MpRecovChance,
            MpRecovStatChance,
            MpRecovMaxStat,
            PoisonRecovChance,
            PoisonRecovStatChance,
            PoisonRecovMaxStat;

        public byte CriticalRateChance,
            CriticalRateStatChance,
            CriticalRateMaxStat,
            CriticalDamageChance,
            CriticalDamageStatChance,
            CriticalDamageMaxStat;

        public byte FreezeChance,
            FreezeStatChance,
            FreezeMaxStat,
            PoisonAttackChance,
            PoisonAttackStatChance,
            PoisonAttackMaxStat;

        public byte AttackSpeedChance,
            AttackSpeedStatChance,
            AttackSpeedMaxStat,
            LuckChance,
            LuckStatChance,
            LuckMaxStat;
    ...
    public class ChatItem {
        ...
        public string RegexInternalName => $"<{Title.Replace("(", "\\(").Replace(")", "\\)")}>";

        public string InternalName => $"<{Title}/{UniqueID}>";
