...
namespace CMirLibraryViewer {
    public partial class LMain : Form {
        ...
        private List<Bitmap> _LImageList = new();
        ...
        private void PreviewListView_RetrieveVirtualItem(object sender, RetrieveVirtualItemEventArgs e) {
            ...
            if(_library.Images.Count - 1 < getImageIndex) {
                getImageIndex = 0; //<-- Prevents NullReferenceException
            }
        ...
        private void checkCenter_CheckedChanged(object sender, EventArgs e) {
