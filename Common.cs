...
public enum Monster : ushort
{
    ...
    MubZommbie = 263,
    FrozenZombie = 264,
    UndeadWolf = 265,  // mountain pass same mobs
    Demonwolf = 266,   // mountain pass same mobs
    WhiteMammoth = 267,
    DarkBeast = 268,
    LightBeast = 269,
    Bloodbaboon = 270,
    ...
    GeneralJinmYo = 284,
    Bunny = 285,
    Bunny2 = 402, // buny to this file that i add a 285 had to bunnys in it files are on lomcn 
