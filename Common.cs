...
public enum Monster : ushort
{
    ...
    //Mob141 = 141, //duplicate of brownfrogspider
    Pig = 142,
    Bull = 143,
    Bush = 144,
    ChristmasTree = 145,
    ...
    Weaver = 204, //correct??
    VenomWeaver = 205,
    CrackingWeaver = 206, //correct??
    ArmingWeaver = 207,
    CrystalWeaver = 208,
    FrozenZumaStatue = 209, //correct??
    FrozenZumaGuardian = 210, //correct??
    FrozenRedZuma = 211, //correct??
    GreaterWeaver = 212, //correct??
    SpiderWarrior = 213, //correct??
    SpiderBarbarian = 214, //correct??
    HellSlasher = 215, //correct??
    HellPirate = 216, //correct??
    HellCannibal = 217,
    HellKeeper = 218,
    HellBolt = 219,
    WitchDoctor = 220,
    ManectricHammer = 221, //correct??
    ManectricClub = 222, //correct??
    ManectricClaw = 223, //correct??
    ManectricStaff = 224, //correct??
    Demon1 = 225,
    Demon2 = 226,
    Demon3 = 227,
    ManectricBlest = 228,
    ...
    FrozenDoor = 230,
    IcePillar = 231,
    FrostYeti = 232, //correct??
    ManectricSlave = 233, //correct??
    TrollHammer = 234,
    TrollBomber = 235,
    TrollStoner = 236,
    TrollKing = 237,
