...
{
   // Warrior = 1,  stupple note may need to chnage
  // Wizard = 2,
  //  Taoist = 4,
  //  Assassin = 8,
 //   Archer = 16,
...
/// stupple chnage  stuff to requiredclass my need to review this
...
public class ItemInfo
{
    ...
    public ItemInfo(BinaryReader reader, int version = int.MaxValue)
    {
        ...
        RequiredClass = (RequiredClass)(version <= 65 ? ConvertRequiredClass(reader.ReadByte()) : reader.ReadByte());//stupple
...
public class TransformData //stupple could be taking out 
{
    public ushort Image;
    public short Shape;
...
public class ClientMagic
{
    ...
    public ClientMagic(BinaryReader reader)
    {
        ...
        if (version >= 66) Level4 = reader.ReadByte();
        Need1 = reader.ReadUInt16();
        Need2 = reader.ReadUInt16();
        Need3 = reader.ReadUInt16();
        if (version >= 66)  Need4 = reader.ReadUInt16();
        Level = reader.ReadByte();
        Key = reader.ReadByte();
        Experience = reader.ReadUInt16();
        if (version >= 66) IsHumUpTrain = reader.ReadBoolean();
