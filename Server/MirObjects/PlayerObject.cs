    ...
    public sealed class PlayerObject : MapObject
    {
       ...
       public void TalkMonster(uint objectID)
        ...
        public bool Match(AuctionInfo info)
        {
            ...
            return (UserMatch || !info.Expired && !info.Sold) && ((MatchType == ItemType.Nothing || info.Item.Info.Type == MatchType) && (info.Item.Info.Shape >= MinShapes && info.Item.Info.Shape <= MaxShapes) &&
