    ...
    public class FrozenMagician : MonsterObject {
        ...
        public void RangeAttack() {
            ...
            if(Envir.Random.Next(3) > 0) {
                ...
                DelayedAction action = new(DelayedType.RangeDamage, Envir.Time + 100 + delay, Target, damage,
                ...
                DelayedAction action = new(DelayedType.RangeDamage, Envir.Time + 250 + delay, Target, damage * 3 / 2,
                    DefenceType.MACAgility);
                ActionList.Add(action);
            }
        }
