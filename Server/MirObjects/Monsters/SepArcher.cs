    ...
    public class SepArcher : MonsterObject
    {
        ...
        protected override void Attack()
        {
            ...
            if (Envir.Random.Next(5) == 0)
            {
                ...
                action = new DelayedAction(DelayedType.Damage, Envir.Time + delay, Target, (int)(damage * 0.8), DefenceType.ACAgility);
                ActionList.Add(action);

                action = new DelayedAction(DelayedType.Damage, Envir.Time + delay + 100, Target, (int)(damage * 0.8), DefenceType.ACAgility);
                ActionList.Add(action);
                return;
            }
        ...
        public override Packet GetInfo()
        {
            ...
            return new S.ObjectPlayer
            {
                ...
                //Class = master != null ? master.Class : MirClass.Archer,
