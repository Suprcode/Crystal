    ...
    public class SepArcher : MonsterObject {
        ...
        protected override void Attack() {
            ...
            if(Envir.Random.Next(5) > 0) {
                Broadcast(new ServerPacket.ObjectMagic {
                    ObjectID = ObjectID, Direction = Direction, Location = CurrentLocation, Spell = Spell.DoubleShot,
                    TargetID = Target.ObjectID, Target = Target.CurrentLocation, Cast = true, Level = 3
                });
            ...
            Broadcast(new ServerPacket.ObjectMagic {
                ObjectID = ObjectID, Direction = Direction, Location = CurrentLocation, Spell = Spell.StraightShot,
                TargetID = Target.ObjectID, Target = Target.CurrentLocation, Cast = true, Level = 3
            });
            ProjectileAttack(damage);
