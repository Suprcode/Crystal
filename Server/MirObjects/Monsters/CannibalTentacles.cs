...
namespace Server.Library.MirObjects.Monsters {
    public class CannibalTentacles : MonsterObject {
        ...
        protected override void HalfmoonAttack(int damage, int delay = 500,
            ...
            for (int i = 0; i < 4; i++) {
                ...
                for (int o = 0; o < cell.Objects.Count; o++) {
                    ...
                    DelayedAction action = new(DelayedType.Damage, Envir.Time + delay, ob, damage, defenceType, true);
                    ActionList.Add(action);
                    break;
                }
            }
