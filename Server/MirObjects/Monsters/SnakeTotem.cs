...
namespace Server.Library.MirObjects.Monsters {
    public class SnakeTotem : MonsterObject {
                        ...
                        for (int i = 0; i < cell.Objects.Count; i++) {
                            ...
                            switch (ob.Race) {
                                case ObjectType.Monster:
                                    ...
                                    ob.Target =
                                        this; //Agro the mobs in range - Very simple agro system overwriting mobs target
                                    continue;
                                default:
                                    continue;
                            }
        ...
        public bool SpawnMinion() {
            ...
            ((CharmedSnake)monster).AliveTime = Envir.Time + ((PetLevel * 2000) + 10000);
            ((CharmedSnake)monster).MasterTotem = this;
