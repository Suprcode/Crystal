            ...
            {
                {
                    if (Envir.Random.Next(3) > 0)
                    {
                        ...
                        DelayedAction action = new DelayedAction(DelayedType.RangeDamage, Envir.Time + 600, Target, damage, DefenceType.MACAgility, 5);
                        ActionList.Add(action);
                    }
                    else
                    {
                        ...
                        DelayedAction action = new DelayedAction(DelayedType.RangeDamage, Envir.Time + 500, Target, damage, DefenceType.MAC, 4);
                        ActionList.Add(action);
                    }
                }
            }
