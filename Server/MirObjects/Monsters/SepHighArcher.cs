    ...
    public class SepHighArcher : MonsterObject
    {
        ...
        protected override void Attack()
        {
            ...
            if (hasPoisonBuff && Envir.Random.Next(2) == 0)
            {
                ...
                action = new DelayedAction(DelayedType.Damage, Envir.Time + delay, Target, hasPoisonBuff ? damage * 2 : damage, DefenceType.MAC);
            ...
            if (Envir.Random.Next(10) <= 4)
            {
                if (!hasPoisonBuff)
                {
                    AddBuff(BuffType.VampireShot, this, Settings.Second * 1000, new Stats());
                }
            }
