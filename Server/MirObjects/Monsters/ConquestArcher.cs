...
namespace Server.Library.MirObjects.Monsters {
    public class ConquestArcher : TownArcher {
                        ...
                        for (int i = 0; i < cell.Objects.Count; i++) {
                            ...
                            switch (ob.Race) {
                                case ObjectType.Player:
                                    ...
                                    if((playerob.MyGuild != null && playerob.MyGuild.Conquest != null &&
                                        Conquest.Info.Index == playerob.MyGuild.Conquest.Info.Index) ||
                                       (ob.Hidden && (!CoolEye || Level < ob.Level)) || !Conquest.WarIsOn) {
                                        continue;
                                    }
        ...
        public override int Attacked(HumanObject attacker, int damage, DefenceType type = DefenceType.ACAgility,
            ...
            if(!Conquest.WarIsOn ||
               (attacker.MyGuild != null && Conquest.GuildInfo.Owner == attacker.MyGuild.Guildindex)) {
                damage = 0;
            }
