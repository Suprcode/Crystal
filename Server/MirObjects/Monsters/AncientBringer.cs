...
namespace Server.Library.MirObjects.Monsters {
    public class AncientBringer : MonsterObject {
        ...
        protected override void CompleteRangeAttack(IList<object> data) {
            ...
            List<MapObject> targets = FindAllTargets(range, target.CurrentLocation);
        ...
        protected void PoisonLineAttack(int distance, int additionalDelay = 500,
                                        DefenceType defenceType = DefenceType.ACAgility, bool poison = false) {
            int damage = GetAttackPower(Stats[Stat.MinDC], Stats[Stat.MaxDC]);
            if(damage == 0) {
                return;
            }
            ...
            for (int i = 1; i <= distance; i++) {
                ...
                for (int o = 0; o < cell.Objects.Count; o++) {
                    ...
                    if(ob.Race == ObjectType.Monster || ob.Race == ObjectType.Player) {
                        ...
                        DelayedAction action = new(DelayedType.Damage, Envir.Time + 300, ob, damage, defenceType,
                            poison);
                        ActionList.Add(action);
                    }
                }
