    ...
    public class Armadillo : DigOutZombie {
        ...
        protected override void Attack() {
            ...
            switch (Envir.Random.Next(0, 6)) {
                ...
                case 1: {
                    ...
                    DelayedAction action = new(DelayedType.Damage, Envir.Time + 400, Target, damage / 2,
                    ...
                    action = new DelayedAction(DelayedType.Damage, Envir.Time + 600, Target, damage / 2,
                        DefenceType.ACAgility);
                    ActionList.Add(action);
                    ...
                    action = new DelayedAction(DelayedType.Damage, Envir.Time + 800, Target, damage / 2,
                        DefenceType.ACAgility);
                    ActionList.Add(action);
                }
                    break;
        ...
        protected void Retreat() {
            ...
            Broadcast(new ServerPacket.ObjectBackStep
                { ObjectID = ObjectID, Direction = Direction, Location = location, Distance = 2 });
            ...
            DelayedAction action = new(DelayedType.RangeDamage, Envir.Time + 900, Target, damage, DefenceType.AC);
            ActionList.Add(action);
        }
