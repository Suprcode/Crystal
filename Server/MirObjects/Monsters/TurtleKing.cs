    ...
    public class TurtleKing : MonsterObject {
        ...
        protected override void Attack() {
            ...
            bool ranged = CurrentLocation == Target.CurrentLocation ||
                          !Functions.InRange(CurrentLocation, Target.CurrentLocation, CloseRange);
            ...
            if(!ranged) {
                ...
                if(!Functions.InRange(CurrentLocation, Target.CurrentLocation, CloseRange) &&
                ...
                } else if(!Functions.InRange(CurrentLocation, Target.CurrentLocation, CloseRange) &&
                          Envir.Random.Next(4) == 0) {
                    Broadcast(new ServerPacket.ObjectRangeAttack
        ...
        protected override void CompleteRangeAttack(IList<object> data) {
            ...
            for (int i = 0; i < targets.Count; i++) {
                Broadcast(new ServerPacket.ObjectEffect
                    { ObjectID = Target.ObjectID, Effect = SpellEffect.TurtleKing });
