        ...
        protected override void Attack() {
            ...
            if(!range && Envir.Random.Next(3) > 0) {
                if(Envir.Time >= PullTime) {
                    ...
                    Target.Pushed(this, Functions.DirectionFromPoint(CurrentLocation, Target.CurrentLocation),
                        2 + Envir.Random.Next(3));
                ...
                DelayedAction action = new(DelayedType.Damage, Envir.Time + 500, Target, damage * 2, DefenceType.AC);
                ActionList.Add(action);
            }
