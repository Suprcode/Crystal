            ...
            if(ranged) {
                ...
                for (int i = 1; i <= 2; i++) {
                    ...
                    for (int o = 0; o < cell.Objects.Count; o++) {
                        ...
                        if(ob.Race == ObjectType.Monster || ob.Race == ObjectType.Player) {
                            ...
                            if(isCrit) {
                                DelayedAction action1 = new(DelayedType.SpellEffect, Envir.Time + delay, ob,
                ...
                for (int i = 0; i < 6; i++) {
                    ...
                    for (int o = 0; o < cell.Objects.Count; o++) {
                        ...
                        DelayedAction action = new(DelayedType.Damage, Envir.Time + 600, ob, damage,
                            DefenceType.ACAgility);
                        ActionList.Add(action);

                        if(isCrit) {
                            DelayedAction action1 = new(DelayedType.SpellEffect, Envir.Time + 600, ob,
                                SpellEffect.FurbolgWarriorCritical);
                            ActionList.Add(action1);
                        }
