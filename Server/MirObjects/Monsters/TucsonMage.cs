...
namespace Server.Library.MirObjects.Monsters {
    public class TucsonMage : MonsterObject {
        ...
        private void WideLineAttack() {
            ...
            Point forward = Functions.PointMove(CurrentLocation, Direction, 1);
            ...
            if(cell.Objects != null) {
                for (int o = 0; o < cell.Objects.Count; o++) {
                    ...
                    if(ob.Race == ObjectType.Monster || ob.Race == ObjectType.Player) {
                        ...
                        DelayedAction action = new(DelayedType.Damage, Envir.Time + 300, ob, damage,
            ...
            MirDirection direction = Functions.PreviousDir(Direction);
                    ...
                    for (int o = 0; o < cell.Objects.Count; o++) {
                        ...
                        if(ob.Race == ObjectType.Monster || ob.Race == ObjectType.Player) {
                            ...
                            int delay = (Functions.MaxDistance(CurrentLocation, ob.CurrentLocation) * 50) +
                                        500; //50 MS per Step
                            DelayedAction action = new(DelayedType.Damage, Envir.Time + delay, ob, damage,
                                DefenceType.ACAgility);
                            ActionList.Add(action);
                        } else {
                            continue;
