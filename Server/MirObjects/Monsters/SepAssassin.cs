...
namespace Server.MirObjects.Monsters
{
    public class SepAssassin : MonsterObject
    {
        ...
        protected override void Attack()
        {
            ...
            DelayedAction  action = new DelayedAction(DelayedType.Damage, Envir.Time + 500, Target, (int)(damage * 0.8f), DefenceType.ACAgility, false);
        ...
        public void RangeAttack()
        {
            ...
            DelayedAction action = new DelayedAction(DelayedType.Damage, Envir.Time + 500, Target, damage, DefenceType.MACAgility, CurrentLocation, Direction);
            ActionList.Add(action);
