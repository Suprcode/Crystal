    ...
    public class SepTaoist: MonsterObject
    {
        ...
        protected override void Attack()
        {
            ...
            if (!Target.Buffs.Any(e => e.Type == BuffType.Curse) && Envir.Random.Next(8) == 0)
            {
                ...
                action = new DelayedAction(DelayedType.Magic, Envir.Time + 500, this, Spell.Curse, GetAttackPower(Stats[Stat.MinDC], Stats[Stat.MaxDC]) / 2, Target.CurrentLocation, (SLevel * 8 + 6), 3 + ((SLevel + 1) * 2));
