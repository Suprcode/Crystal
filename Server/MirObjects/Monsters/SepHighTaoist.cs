    ...
    public class SepHighTaoist : MonsterObject
    {
        ...
        protected override void Attack()
        {
            ...
            if (!Target.Buffs.Any(e => e.Type == BuffType.Curse) && Envir.Random.Next(8) == 0)
            {
                ...
                int SLevel = Envir.Random.Next(1, 3);
                action = new DelayedAction(DelayedType.Damage, Envir.Time + 500, this, Spell.Curse, GetAttackPower(Stats[Stat.MinDC], Stats[Stat.MaxDC]) / 2, Target.CurrentLocation, (SLevel * 8 + 6), 3 + ((SLevel + 1) * 2));
            ...
            if (PercentHealth <= 90 && Envir.Random.Next(8) == 0)
            {
                ...
                int SLevel = Envir.Random.Next(1, 3);
                action = new DelayedAction(DelayedType.Damage, Envir.Time + 500, this, Spell.MassHealing, GetAttackPower(Stats[Stat.MinSC], Stats[Stat.MaxSC]) / 2 + (Envir.Random.Next(1,3) + 1) * 2, CurrentLocation);
                ActionList.Add(action);
                return;
            }
        ...
        public override Packet GetInfo()
        {
            ...
            return new S.ObjectPlayer
            {
                ...
                //Class = master != null ? master.Class : MirClass.Taoist,
