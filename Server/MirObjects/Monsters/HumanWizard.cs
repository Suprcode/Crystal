    ...
    public class HumanWizard : MonsterObject {
        ...
        protected override void Attack() {
            ...
            Broadcast(new ServerPacket.ObjectMagic {
                ObjectID = ObjectID, Direction = Direction, Location = CurrentLocation, Spell = Spell.ThunderBolt,
            ...
            DelayedAction action = new(DelayedType.Damage, Envir.Time + 500, Target, damage, DefenceType.MAC);
        ...
        protected override void ProcessAI() {
            ...
            if(Master != null && Master is PlayerObject && Envir.Time > DecreaseMPTime) {
                ...
                if(!Master.Dead) {
                    ((PlayerObject)Master).ChangeMP(-10);
                }

                if(((PlayerObject)Master).MP <= 0) {
                    Die();
                }
            }
        }
