    ...
    public class TrapRock : MonsterObject {
        ...
        protected override void ProcessAI() {
            ...
            if(Envir.Time > VisibleTime) {
                ...
                if(!Visible && visible && !Target.Dead && !Target.InTrapRock) {
                    ...
                    if(Teleport(CurrentMap, Functions.PointMove(Target.CurrentLocation, (MirDirection)SpawnCorner, 1),
                           false)) {
        ...
        protected override void Attack() {
            ...
            if(Envir.Random.Next(8) == 0 && !ChildRock) {
                Target.ApplyPoison(new Poison { PType = PoisonType.Paralysis, Duration = 3, TickSpeed = 1000 }, this,
                    true);
            }
        ...
        public void Show() {
            ...
            if(!ChildRock) {
                ...
                for (byte i = 0; i <= 6; i += 2) {
                    ...
                    TrapRock childmob = (TrapRock)mob;
                    ...
                    if(childmob.Spawn(CurrentMap, Functions.PointMove(Target.CurrentLocation, (MirDirection)i, 1))) {
                        ...
                        childmob.Show();
                        childmob.ActionTime = ActionTime;
                        childmob.AttackTime = AttackTime;
                    } else {
                        continue;
                    }
                }
