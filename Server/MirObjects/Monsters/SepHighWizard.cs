    ...
    public class SepHighWizard : MonsterObject
    {
        ...
        protected override void Attack()
        {
            ...
            if (Functions.InRange(CurrentLocation, Target.CurrentLocation, 2) && Envir.Random.Next(3) == 0)
            {
                ...
                action = new DelayedAction(DelayedType.Damage, Envir.Time + delay, Target, (int)(GetAttackPower(Stats[Stat.MinDC], Stats[Stat.MaxDC])*1.5), CurrentLocation);
            ...
            if (Envir.Random.Next(3) == 0)
            {
                ...
                action = new DelayedAction(DelayedType.Damage, Envir.Time + delay, Target, GetAttackPower(Stats[Stat.MinDC], Stats[Stat.MaxDC]), Target.CurrentLocation);
                ActionList.Add(action);
                return;
            }
            ...
            if (PercentHealth <= 80 && Envir.Random.Next(4) == 0)
            {
                ...
                action = new DelayedAction(DelayedType.Damage, Envir.Time + delay, Target, GetAttackPower(Stats[Stat.MinDC], Stats[Stat.MaxDC]), Target);
                ActionList.Add(action);
                return;
            }
