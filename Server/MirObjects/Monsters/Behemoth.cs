...
namespace Server.Library.MirObjects.Monsters {
    public class Behemoth : MonsterObject {
            ...
            if(!ranged) {
                switch (Envir.Random.Next(5)) {
                    ...
                    case 4: {
                        ...
                        DelayedAction action = new(DelayedType.Damage, Envir.Time + 300, Target, 0,
        ...
        protected override void CompleteRangeAttack(IList<object> data) {
            ...
            for (int i = 0; i < targets.Count; i++) {
                Broadcast(new ServerPacket.ObjectEffect
                    { ObjectID = targets[i].ObjectID, Effect = SpellEffect.Behemoth });
            ...
            } else //Push back
            {
                ...
                if(cell.Objects != null) {
                    for (int o = 0; o < cell.Objects.Count; o++) {
                        ...
                        if(t == null || t.Race != ObjectType.Player) {
                            continue;
                        }
        ...
        public override void Die() {
            foreach(MonsterObject slave in SlaveList) {
                slave.Die();
            }
