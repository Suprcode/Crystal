...
namespace Server.Library.MirObjects.Monsters {
    internal class HellKeeper : MonsterObject {
        ...
        protected override void Attack() {
            ...
            Broadcast(new ServerPacket.ObjectAttack
                { ObjectID = ObjectID, Direction = Direction, Location = CurrentLocation, Type = attacktype1 });

            DelayedAction action = new(DelayedType.Damage, Envir.Time + 300, attacktype1);
