    ...
    public class SepHighWarrior : MonsterObject {
        ...
        public void TwinDrakeBlade() {
            ...
            Broadcast(new ServerPacket.ObjectAttack {
                ObjectID = ObjectID, Direction = Direction, Location = CurrentLocation, Spell = Spell.TwinDrakeBlade
            });
            ...
            if((Target.Race != ObjectType.Player || Settings.PvpCanResistPoison) &&
               ...
               Target.Level <= Level + 8 && Envir.Random.Next(20) <= 5) {
        ...
        public void CrossHalfMoon() {
            ...
            Broadcast(new ServerPacket.ObjectAttack {
                ObjectID = ObjectID, Direction = Direction, Location = CurrentLocation, Spell = Spell.CrossHalfMoon
            });
        ...
        public void BladeAvalanche() {
            ...
            Broadcast(new ServerPacket.ObjectMagic {
                ObjectID = ObjectID, Direction = Direction, Location = CurrentLocation, Spell = Spell.BladeAvalanche,
