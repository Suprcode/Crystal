...
namespace Server.MirObjects.Monsters
{
    public class SepHighWarrior : MonsterObject
    {
        ...
        public void TwinDrakeBlade()
        {
            ...
            DelayedAction action = new DelayedAction(DelayedType.Damage, Envir.Time + 500, Target, (int)(damage * 0.8), DefenceType.ACAgility);
        ...
        public void CrossHalfMoon()
        {
            ...
            {
                DelayedAction  action = new DelayedAction(DelayedType.Damage, Envir.Time + 600, targets[i], damage, DefenceType.ACAgility);
                ActionList.Add(action);
            }
