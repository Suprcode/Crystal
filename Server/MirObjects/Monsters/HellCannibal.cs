    ...
    public class HellCannibal : MonsterObject {
        ...
        protected override void Attack() {
            ...
            if(Envir.Random.Next(4) > 0) {
                ...
                DelayedAction action = new(DelayedType.Damage, Envir.Time + 300, Target, 0, DefenceType.ACAgility,
                    true);
                ActionList.Add(action);
            }
        }
        ...
        protected override void CompleteAttack(IList<object> data) {
            ...
            if(poison) {
                ...
                for (int i = 0; i < targets.Count; i++) {
                    PoisonTarget(targets[i], 1,
                        Envir.Random.Next(GetAttackPower(Stats[Stat.MinSC], Stats[Stat.MaxSC]) / 2), PoisonType.Red,
                        1000);
                }
            } else {
