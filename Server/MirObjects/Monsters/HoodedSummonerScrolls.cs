...
namespace Server.Library.MirObjects.Monsters {
    /// <summary>
    ///     Contains AI's for all of the HoodedSummoner's scrolls (WarriorScroll / TaoistScroll / WizardScroll /
    ///     AssassinScroll).
    ...
    ///     AssassinScroll = 3
    /// </summary>
    internal class HoodedSummonerScrolls : ZumaMonster {
        ...
        protected override void Attack() {
            ...
            switch (Info.Effect) {
                case 0: // WarriorScroll - FireWall attack?
                    ...
                    DelayedAction warriorScrollAction = new(DelayedType.Damage, Envir.Time + 500, Target, damage,
                ...
                case 1: // TaoistScroll - PoisonCloud + PoisonExplosion on death.
                    ...
                    DelayedAction taoistScrollAction = new(DelayedType.RangeDamage, Envir.Time + 500, Target, damage,
                ...
                case 2: // WizardScroll - Projectile Attack (D16).
                    ...
                    DelayedAction wizardScrollAction = new(DelayedType.Damage, Envir.Time + delay, Target, damage,
                        DefenceType.MACAgility);
                ...
                case 3: // AssassinScroll - ThunderBolt Attack.
                    ...
                    DelayedAction assassinScrollAction = new(DelayedType.Damage, Envir.Time + 500, Target, damage,
                        DefenceType.MACAgility);
