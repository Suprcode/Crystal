...
namespace Server.Systems {
    public partial class GuildInfoForm : Form {
        ...
        private GuildBuffInfo SelectedBuff;
        ...
        private void UpdateGuildInterface() {
            ...
            if(GuildLevelListcomboBox.SelectedItem == null ||
               GuildLevelListcomboBox.SelectedIndex >= Settings.Guild_ExperienceList.Count ||
               GuildLevelListcomboBox.SelectedIndex >= Settings.Guild_MembercapList.Count) {
                GuildExpNeededtextBox.Text = string.Empty;
                GuildMemberCaptextBox.Text = string.Empty;
            } else {
                GuildExpNeededtextBox.Text =
                    Settings.Guild_ExperienceList[GuildLevelListcomboBox.SelectedIndex].ToString();
                GuildMemberCaptextBox.Text =
                    Settings.Guild_MembercapList[GuildLevelListcomboBox.SelectedIndex].ToString();
            }

            if(GuildCreateListcomboBox.SelectedItem == null ||
               GuildCreateListcomboBox.SelectedIndex >= Settings.Guild_CreationCostList.Count) {
                ...
                if(Settings.Guild_CreationCostList[GuildCreateListcomboBox.SelectedIndex].Item == null) {
                    ...
                    GuildItemNamecomboBox.SelectedIndex =
                        Settings.Guild_CreationCostList[GuildCreateListcomboBox.SelectedIndex].Item.Index;
                }

                GuildAmounttextBox.Text = Settings.Guild_CreationCostList[GuildCreateListcomboBox.SelectedIndex].Amount
                    .ToString();
            }
        ...
        private void GuildItemNamecomboBox_SelectedIndexChanged(object sender, EventArgs e) {
            ...
            if(GuildItemNamecomboBox.SelectedIndex == 0) {
                ...
                Settings.Guild_CreationCostList[GuildCreateListcomboBox.SelectedIndex].Item =
                    (ItemInfo)GuildItemNamecomboBox.SelectedItem;
                Settings.Guild_CreationCostList[GuildCreateListcomboBox.SelectedIndex].ItemName =
                    Settings.Guild_CreationCostList[GuildCreateListcomboBox.SelectedIndex].Item.Name;
            }
        ...
        private void BuffDelete_Click(object sender, EventArgs e) {
            ...
            if(MessageBox.Show("Are you sure you want to remove the selected guildbuff?", "Remove guildbuff?",
        ...
        private void BufftxtTimeLimit_TextChanged(object sender, EventArgs e) {
            uint temp2 = 0;
            int temp = 0;
            if(!IsValid(ref temp2, sender) || !IsValid(ref temp, sender)) {
                return;
            }
