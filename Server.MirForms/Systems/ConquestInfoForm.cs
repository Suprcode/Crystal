    ...
    public partial class ConquestInfoForm : Form {
        ...
        private void UpdateArchers() {
            ...
            if(selectedArcher != null) {
                ...
                ArcherIndex_combo.SelectedItem =
                    Envir.MonsterInfoList.FirstOrDefault(x => x.Index == selectedArcher.MobIndex);
        ...
        private void UpdateGates() {
            if(selectedGate != null) {
                ...
                GateIndex_combo.SelectedItem =
                    Envir.MonsterInfoList.FirstOrDefault(x => x.Index == selectedGate.MobIndex);
        ...
        private void UpdateWalls() {
            if(selectedWall != null) {
                ...
                WallIndex_combo.SelectedItem =
                    Envir.MonsterInfoList.FirstOrDefault(x => x.Index == selectedWall.MobIndex);
        ...
        private void UpdateSiege() {
            if(selectedSiege != null) {
                ...
                SiegeIndex_combo.SelectedItem =
                    Envir.MonsterInfoList.FirstOrDefault(x => x.Index == selectedSiege.MobIndex);
        ...
        private void UpdateInterface() {
            ...
            if(selectedConquest != null) {
                ...
                ConquestMap_combo.SelectedItem =
                    Envir.MapInfoList.FirstOrDefault(x => x.Index == selectedConquest.MapIndex);
                PalaceMap_combo.SelectedItem =
                    Envir.MapInfoList.FirstOrDefault(x => x.Index == selectedConquest.PalaceIndex);
                ...
                for (int i = 0; i < selectedConquest.ExtraMaps.Count; i++) {
                    Maps_listbox.Items.Add(
                        Envir.MapInfoList.FirstOrDefault(x => x.Index == selectedConquest.ExtraMaps[i]));
                }
        ...
        private void AddConq_button_Click(object sender, EventArgs e) {
            Envir.ConquestInfoList.Add(new ConquestInfo {
                Index = ++Envir.ConquestIndex, Location = new Point(0, 0), Size = 10, Name = "Conquest Wall",
                MapIndex = 1, PalaceIndex = 2
            });
            UpdateInterface();
        }
        ...
        private void AddGuard_button_Click(object sender, EventArgs e) {
            if(selectedConquest != null) {
                selectedConquest.ConquestGuards.Add(new ConquestArcherInfo {
                    Location = new Point(0, 0), Name = "Guard", Index = ++selectedConquest.GuardIndex, MobIndex = 1,
                    RepairCost = 1000
                });
                UpdateInterface();
            }
        ...
        private void AddGate_button_Click(object sender, EventArgs e) {
            if(selectedConquest != null) {
                selectedConquest.ConquestGates.Add(new ConquestGateInfo {
                    Location = new Point(0, 0), Name = "Gate", Index = ++selectedConquest.GateIndex, MobIndex = 1,
                    RepairCost = 1000
                });
                UpdateInterface();
            }
        ...
        private void AddWall_button_Click(object sender, EventArgs e) {
            if(selectedConquest != null) {
                selectedConquest.ConquestWalls.Add(new ConquestWallInfo {
                    Location = new Point(0, 0), Name = "Wall", Index = ++selectedConquest.WallIndex, MobIndex = 1,
                    RepairCost = 1000
                });
                UpdateInterface();
            }
        ...
        private void RemoveConq_button_Click(object sender, EventArgs e) {
            ...
            if(MessageBox.Show("Are you sure you want to remove the selected Conquest?", "Remove Items?",
            ...
            if(Envir.ConquestInfoList.Count == 0) {
                Envir.ConquestIndex = 0;
            }
        ...
        private void AddSiege_button_Click(object sender, EventArgs e) {
            if(selectedConquest != null) {
                selectedConquest.ConquestSieges.Add(new ConquestSiegeInfo {
                    Location = new Point(0, 0), Name = "Siege", Index = ++selectedConquest.SiegeIndex, MobIndex = 1,
                    RepairCost = 1000
                });
                UpdateInterface();
            }
        ...
        private void AddFlag_button_Click(object sender, EventArgs e) {
            ...
            if(selectedConquest != null) {
                selectedConquest.ConquestFlags.Add(new ConquestFlagInfo
                    { Location = new Point(0, 0), Name = "Flag", Index = ++selectedConquest.FlagIndex });
                UpdateInterface();
            }
        }
        ...
        private void AddControl_button_Click(object sender, EventArgs e) {
            ...
            if(selectedConquest != null) {
                selectedConquest.ControlPoints.Add(new ConquestFlagInfo {
                    Location = new Point(0, 0), Name = "Control Point", Index = ++selectedConquest.ControlPointIndex
                });
                UpdateInterface();
            }
        }
