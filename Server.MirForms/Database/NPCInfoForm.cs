    ...
    public partial class NpcInfoForm : Form {
        ...
        public NpcInfoForm() {
            ...
            for (int i = 0; i < Envir.MapInfoList.Count; i++) {
                MapComboBox.Items.Add(Envir.MapInfoList[i]);
            }
        ...
        private void RemoveButton_Click(object sender, EventArgs e) {
            ...
            if(MessageBox.Show("Are you sure you want to remove the selected Npcs?", "Remove Npcs?",
        ...
        private void UpdateInterface() {
            ...
            for (int i = 1; i < _selectedNpcInfos.Count; i++) {
                ...
                if(BigMapIconTextBox.Text != info.BigMapIcon.ToString()) {
                    BigMapIconTextBox.Text = string.Empty;
                }
            }
        }
        ...
        private void ExportSelected_Click(object sender, EventArgs e) {
            List<Library.MirDatabase.NpcInfo> list = NpcInfoListBox.SelectedItems.Cast<Library.MirDatabase.NpcInfo>()
                .ToList();
        ...
        private void ImportButton_Click(object sender, EventArgs e) {
            ...
            string[] npcs = data.Split(new[] { "\r\n" }, StringSplitOptions.RemoveEmptyEntries);

            foreach(string m in npcs) {
                try {
        ...
        private void OpenNButton_Click(object sender, EventArgs e) {
            if(NFileNameTextBox.Text == string.Empty) {
                return;
            }

            string scriptPath = Path.Combine(Settings.NpcPath, NFileNameTextBox.Text + ".txt");
