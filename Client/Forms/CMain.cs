...
namespace Client
{
    public partial class CMain : RenderForm
    {
        ...
        private void CMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                GameScene.Scene.ChatDialog.ReceiveChat(string.Format(GameLanguage.ClientTextMap.GetLocalization(ClientTextKeys.CannotLeaveGame) , (GameScene.LogTime - CMain.Time) / 1000), ChatType.System);
                e.Cancel = true;
            }
            else
            {
