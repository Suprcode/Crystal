...
namespace Client
{
    public partial class CMain : RenderForm
    {
        ...
        {
            this.Text = GameLanguage.ClientTextMap[nameof(ClientTextKeys.GameName)];
            try
            {
        ...
        private static void CreateDebugLabel()
        {
            ...
            else
            {
                ...
                Program.Form.Text = $"{GameLanguage.ClientTextMap[nameof(ClientTextKeys.GameName)]} - {text}";
            }
        }
        ...
        private void CMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                GameScene.Scene.ChatDialog.ReceiveChat(string.Format(GameLanguage.ClientTextMap[nameof(ClientTextKeys.CannotLeaveGame)] , (GameScene.LogTime - CMain.Time) / 1000), ChatType.System);
                e.Cancel = true;
            }
            else
            {
