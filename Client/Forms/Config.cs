...
namespace Client.Forms {
    public partial class Config : Form {
        ...
        private void Config_Load(object sender, EventArgs e) {
            label10.Text = GameLanguage.Resolution;
            AutoStart_label.Text = GameLanguage.Autostart;
            ID_l.Text = GameLanguage.Usrname;
            Password_l.Text = GameLanguage.Password;
        ...
        public void resolutionChoice(eSupportedResolution res) {
            Res2_pb.Image = Images.Radio_Unactive;
            Res3_pb.Image = Images.Radio_Unactive;
            Res4_pb.Image = Images.Radio_Unactive;
            Res5_pb.Image = Images.Radio_Unactive;

            switch (res) {
                case eSupportedResolution.w1024h768:
                    Res2_pb.Image = Images.Config_Radio_On;
                    break;
                case eSupportedResolution.w1366h768:
                    Res3_pb.Image = Images.Config_Radio_On;
                    break;
                case eSupportedResolution.w1280h720:
                    Res4_pb.Image = Images.Config_Radio_On;
                    break;
                case eSupportedResolution.w1920h1080:
                    Res5_pb.Image = Images.Config_Radio_On;
                    break;
            }
        ...
        private void Config_VisibleChanged(object sender, EventArgs e) {
            if(Visible) {
                ...
                Fullscreen_pb.Image = Settings.FullScreen
                    ? Images.Config_Check_On
                    : Images.Config_Check_Off1;
        ...
        private void AccountLogin_txt_TextChanged(object sender, EventArgs e) {
            if(AccountLogin_txt.Text == string.Empty) {
                ID_l.Visible = true;
            } else {
                ID_l.Visible = false;
            }
        ...
        private void AccountPass_txt_TextChanged(object sender, EventArgs e) {
            if(AccountPass_txt.Text == string.Empty) {
