...
namespace Client
{
    public partial class CMain : Form
    {
        ...
        private void CMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                GameScene.Scene.ChatDialog.ReceiveChat(string.Format(GameLanguage.CannotLeaveGame, (GameScene.LogTime - CMain.Time) / 1000, GameLanguage.Seconds), ChatType.System);
                e.Cancel = true;
            }
        }
    }
