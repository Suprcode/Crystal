...
namespace Client.MirObjects {
    internal class SpellObject : MapObject {
        ...
        public void Load(ServerPacket.ObjectSpell info) {
            ...
            switch (Spell) {
                ...
                case Spell.DigOutZombie:
                    BodyLibrary = (ushort)Monster.DigOutZombie < Libraries.Monsters.Count()
                        ? Libraries.Monsters[(ushort)Monster.DigOutZombie]
                        : Libraries.Magic;
                ...
                case Spell.MeteorStrike:
                    AnimationOffset = new Point(0, -20);
                    MapControl.Effects.Add(new Effect(Libraries.Magic2, 1600, 10, 800, CurrentLocation)
                        { Repeat = true, RepeatUntil = CMain.Time + 3000 });
                    BodyLibrary = Libraries.Magic2;
                    DrawFrame = 1610;
                    FrameInterval = 100;
                    FrameCount = 30;
                ...
                case Spell.MapLightning:
                    MapControl.Effects.Add(new Effect(Libraries.Dragon, 400 + (CMain.Random.Next(3) * 10), 5, 600,
                        CurrentLocation));
                    SoundManager.PlaySound(8301);
                    break;
                case Spell.MapLava:
                    MapControl.Effects.Add(new Effect(Libraries.Dragon, 440, 20, 1600, CurrentLocation)
                        { Blend = false });
                ...
                case Spell.MapQuake1:
                    MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.HellLord], 27, 12, 1200,
                        CurrentLocation) { Blend = false });
                    SoundManager.PlaySound(8304);
                    break;
                case Spell.MapQuake2:
                    MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.HellLord], 39, 13, 1300,
                        CurrentLocation) { Blend = false });
                    SoundManager.PlaySound(8304);
                    break;
                ...
                case Spell.GeneralMeowMeowThunder:
                    MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.GeneralMeowMeow], 522, 7, 700,
                        CurrentLocation) { Blend = true });
                ...
                case Spell.TreeQueenMassRoots:
                    ...
                    MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.TreeQueen], 97, 14, 1400,
                        CurrentLocation) { Blend = true });
                    break;
                case Spell.TreeQueenGroundRoots:
                    ...
                    MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.TreeQueen], 57, 9, 900,
                        CurrentLocation) { Blend = true });
                    break;
                ...
                case Spell.TucsonGeneralRock:
                    MapControl.Effects.Add(
                        new Effect(Libraries.Monsters[(ushort)Monster.TucsonGeneral], 552, 20, 2000, CurrentLocation)
                            { Repeat = false, Blend = false });
                ...
                case Spell.HornedCommanderRockSpike:
                    ...
                    MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.HornedCommander], 1199, 9, 900,
                        CurrentLocation) { Blend = true });
                    break;
            }
        ...
        public override void Process() {
            if(CMain.Time >= NextMotion) {
                ...
                switch (Spell) {
                    case Spell.TucsonGeneralRock:
                        if(FrameIndex == 10) {
                            SoundManager.PlaySound(8305);
                        }

                        break;
                    case Spell.HornedSorcererDustTornado:
                        if(FrameIndex == 0 && CMain.Random.Next(3) == 0) {
                            SoundManager.PlaySound(8306);
                        }
