    ...
    public abstract class MapObject
    {
        ...
        public void DrawPoison()
        {
            ...
            if (Poison != PoisonType.None)
            {
                ...
                {
                    DXManager.Sprite.Draw(DXManager.PoisonDotBackground, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 7 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 21), 0.0F), Color.Black);
                    DXManager.Sprite.Draw(DXManager.RadarTexture, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 8 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 20), 0.0F), Color.Green);
                ...
                {
                    DXManager.Sprite.Draw(DXManager.PoisonDotBackground, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 7 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 21), 0.0F), Color.Black);
                    DXManager.Sprite.Draw(DXManager.RadarTexture, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 8 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 20), 0.0F), Color.Red);
                    poisoncount++;
                }
                if (Poison.HasFlag(PoisonType.Bleeding))
                {
                    DXManager.Sprite.Draw(DXManager.PoisonDotBackground, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 7 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 21), 0.0F), Color.Black);
                    DXManager.Sprite.Draw(DXManager.RadarTexture, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 8 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 20), 0.0F), Color.DarkRed);
                    poisoncount++;
                }
                if (Poison.HasFlag(PoisonType.Slow))
                {
                    DXManager.Sprite.Draw(DXManager.PoisonDotBackground, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 7 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 21), 0.0F), Color.Black);
                    DXManager.Sprite.Draw(DXManager.RadarTexture, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 8 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 20), 0.0F), Color.Purple);
                    poisoncount++;
                }
                if (Poison.HasFlag(PoisonType.Stun))
                {
                    DXManager.Sprite.Draw(DXManager.PoisonDotBackground, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 7 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 21), 0.0F), Color.Black);
                    DXManager.Sprite.Draw(DXManager.RadarTexture, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 8 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 20), 0.0F), Color.Yellow);
                    poisoncount++;
                }
                if (Poison.HasFlag(PoisonType.Frozen))
                {
                    DXManager.Sprite.Draw(DXManager.PoisonDotBackground, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 7 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 21), 0.0F), Color.Black);
                    DXManager.Sprite.Draw(DXManager.RadarTexture, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 8 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 20), 0.0F), Color.Blue);
                    poisoncount++;
                }
                if (Poison.HasFlag(PoisonType.Paralysis) || Poison.HasFlag(PoisonType.LRParalysis))
                {
                    DXManager.Sprite.Draw(DXManager.PoisonDotBackground, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 7 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 21), 0.0F), Color.Black);
                    DXManager.Sprite.Draw(DXManager.RadarTexture, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 8 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 20), 0.0F), Color.Gray);
                    poisoncount++;
                }
                if (Poison.HasFlag(PoisonType.DelayedExplosion))
                {
                    DXManager.Sprite.Draw(DXManager.PoisonDotBackground, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 7 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 21), 0.0F), Color.Black);
                    DXManager.Sprite.Draw(DXManager.RadarTexture, new Rectangle(0, 0, 2, 2), new Vector3?(Vector3.Zero), new Vector3((float)(DisplayRectangle.X + 8 + (poisoncount * 3)), (float)(DisplayRectangle.Y - 20), 0.0F), Color.Orange);
                    poisoncount++;
                }
            }
        }
