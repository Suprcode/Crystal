                    ...
                    case MirAction.Spell:
                        ...
                        switch (Spell)
                        {
                            ...
                            case Spell.CounterAttack:
                                ...
                                {
                                    int num8 = ((GameScene.User == this) ? MapObject.User.AttackSpeed : MapObject.Hero.AttackSpeed);
                                    FrameInterval = (int)((float)Frame.Interval * Math.Max(0.5f, (float)num8 / 1400f));
                                    EffectFrameInterval = (int)((float)Frame.Interval * Math.Max(0.5f, (float)num8 / 1400f));
                                }
