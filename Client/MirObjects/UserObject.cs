...
namespace Client.MirObjects {
    public class UserObject : PlayerObject {
        ...
        public BaseStats CoreStats = new(0);
        ...
        public List<ClientQuestProgress> CurrentQuests = new();
        ...
        private void RefreshLevelStats() {
            ...
            foreach(BaseStat stat in CoreStats.Stats) {
        ...
        public void RefreshStatCaps() {
            foreach(KeyValuePair<Stat, int> cap in CoreStats.Caps.Values) {
