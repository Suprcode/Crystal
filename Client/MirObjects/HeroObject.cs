    ...
    public class HeroObject : PlayerObject {
        ...
        public override void DrawName() {
            ...
            NameLabel.Location = new Point(DisplayRectangle.X + ((50 - NameLabel.Size.Width) / 2),
                DisplayRectangle.Y - (42 - (NameLabel.Size.Height / 2)) + (Dead ? 35 : 8));
            NameLabel.Draw();

            OwnerLabel.Location = new Point(DisplayRectangle.X + ((50 - OwnerLabel.Size.Width) / 2),
                NameLabel.Location.Y + NameLabel.Size.Height - 1);
            OwnerLabel.Draw();
        }
    }
}
