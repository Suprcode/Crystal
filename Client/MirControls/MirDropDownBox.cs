...
namespace Client.MirControls {
    public class MirDropDownBox : MirControl {
        ...
        private void MirDropDownBox_BeforeDraw(object sender, EventArgs e) {
        ...
        private void ScrollPosition(object sender, MouseEventArgs e) {
            int x = Size.Width - 11;
            int y = _ScrollPosition.Location.Y;
            if(y >= _ScrollDown.Location.Y - 14) {
                y = _ScrollDown.Location.Y - 14;
            }
