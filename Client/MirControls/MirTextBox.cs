    ...
    public sealed class MirTextBox : MirControl {
        ...
        public MirTextBox() {
            ...
            TextBox = new TextBox {
                ...
                Font = new Font(Settings.FontName, 10F * 96f / CMain.Graphics.DpiX),
        ...
        protected override unsafe void CreateTexture() {
            ...
            using(Bitmap bm = new(Size.Width, Size.Height, Size.Width * 4, PixelFormat.Format32bppArgb,
                ...
                using(Graphics graphics = Graphics.FromImage(bm)) {
                    ...
                    if(TextBox.Focused) {
                        graphics.DrawLine(CaretPen, new Point(caret.X, caret.Y),
                            new Point(caret.X, caret.Y + TextBox.Font.Height));
                    }
                }
            }
        ...
        public void DialogChanged() {
            ...
            if((box1 != null && box1 != Parent) || (box2 != null && box2 != Parent) ||
               (box3 != null && box3 != Parent)) {
