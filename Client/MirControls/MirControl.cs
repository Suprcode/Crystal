...
namespace Client.MirControls {
    public class MirControl : IDisposable {
        ...
        public virtual Point DisplayLocation => Parent == null ? Location : Parent.DisplayLocation.Add(Location);
        public Rectangle DisplayRectangle => new(DisplayLocation, Size);
        ...
        public bool Enabled {
            internal get => Parent == null ? _enabled : Parent.Enabled && _enabled;
            set {
                if(_enabled == value) {
                    return;
                }
...
// ReSharper restore InconsistentNaming
        ...
        public virtual Size TrueSize => _size;
        ...
        public virtual bool Visible {
            get => Parent == null ? _visible : Parent.Visible && _visible;
            set {
                if(_visible == value) {
                    return;
                }
        ...
        protected Point Center =>
            new((Settings.ScreenWidth - Size.Width) / 2, (Settings.ScreenHeight - Size.Height) / 2);

        protected Point Left => new(0, (Settings.ScreenHeight - Size.Height) / 2);

        protected Point Top => new((Settings.ScreenWidth - Size.Width) / 2, 0);

        protected Point Right => new(Settings.ScreenWidth - Size.Width, (Settings.ScreenHeight - Size.Height) / 2);

        protected Point Bottom => new((Settings.ScreenWidth - Size.Width) / 2, Settings.ScreenHeight - Size.Height);

        protected Point TopLeft => new(0, 0);

        protected Point TopRight => new(Settings.ScreenWidth - Size.Width, 0);

        protected Point BottomRight => new(Settings.ScreenWidth - Size.Width, Settings.ScreenHeight - Size.Height);

        protected Point BottomLeft => new(0, Settings.ScreenHeight - Size.Height);
        ...
        public void BringToFront() {
            ...
            if(index == _parent.Controls.Count - 1) {
                return;
            }
        ...
        public virtual void Draw() {
            if(IsDisposed || !Visible /*|| Size.Width == 0 || Size.Height == 0*/ || Size.Width > Settings.ScreenWidth ||
               Size.Height > Settings.ScreenHeight) {
                return;
            }
        ...
        protected internal virtual void DrawControl() {
            ...
            DXManager.DrawOpaque(ControlTexture, new Rectangle(0, 0, Size.Width, Size.Height),
                new Vector3?(new Vector3((float)DisplayLocation.X, (float)DisplayLocation.Y, 0.0f)), Color.White,
                Opacity);
        ...
        public virtual Font ScaleFont(Font font) {
            Font theFont = new Font(font.Name, font.Size * 96f / CMain.Graphics.DpiX, font.Style);
            font.Dispose();
