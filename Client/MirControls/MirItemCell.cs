...
namespace Client.MirControls
{
    public sealed class MirItemCell : MirImageControl
    {
        ...
        private void BuyItem()
        {
            ...
            {
                amountBox = new MirAmountBox(GameLanguage.ClientTextMap.GetLocalization(ClientTextKeys.Purchase), Item.Image, string.Format(GameLanguage.ClientTextMap.GetLocalization(ClientTextKeys.ValueGold), Item.Price()));
