...
namespace Client.MirGraphics {
    public static class Libraries {
        ...
        public static readonly MLibrary
            ChrSel = new(Settings.DataPath + "ChrSel"),
            Prguse = new(Settings.DataPath + "Prguse"),
            Prguse2 = new(Settings.DataPath + "Prguse2"),
            Prguse3 = new(Settings.DataPath + "Prguse3"),
            BuffIcon = new(Settings.DataPath + "BuffIcon"),
            Help = new(Settings.DataPath + "Help"),
            MiniMap = new(Settings.DataPath + "MMap"),
            MapLinkIcon = new(Settings.DataPath + "MapLinkIcon"),
            Title = new(Settings.DataPath + "Title"),
            MagIcon = new(Settings.DataPath + "MagIcon"),
            MagIcon2 = new(Settings.DataPath + "MagIcon2"),
            Magic = new(Settings.DataPath + "Magic"),
            Magic2 = new(Settings.DataPath + "Magic2"),
            Magic3 = new(Settings.DataPath + "Magic3"),
            Effect = new(Settings.DataPath + "Effect"),
            MagicC = new(Settings.DataPath + "MagicC"),
            GuildSkill = new(Settings.DataPath + "GuildSkill"),
            Weather = new(Settings.DataPath + "Weather");

        public static readonly MLibrary
            Background = new(Settings.DataPath + "Background");


        public static readonly MLibrary
            Dragon = new(Settings.DataPath + "Dragon");
        ...
        //Items
        public static readonly MLibrary
            Items = new(Settings.DataPath + "Items"),
            StateItems = new(Settings.DataPath + "StateItem"),
            FloorItems = new(Settings.DataPath + "DNItems");

        //Deco
        public static readonly MLibrary
            Deco = new(Settings.DataPath + "Deco");
        ...
        static Libraries() {
            ...
            for (int i = 0; i < Mapstate.Length; i++) {
                MapLibs[200 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Tilesc");
                MapLibs[201 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Tiles30c");
                MapLibs[202 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Tiles5c");
                MapLibs[203 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Smtilesc");
                MapLibs[204 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Housesc");
                MapLibs[205 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Cliffsc");
                MapLibs[206 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Dungeonsc");
                MapLibs[207 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Innersc");
                MapLibs[208 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Furnituresc");
                MapLibs[209 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Wallsc");
                MapLibs[210 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "smObjectsc");
                MapLibs[211 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Animationsc");
                MapLibs[212 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Object1c");
                MapLibs[213 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\WemadeMir3\\" + Mapstate[i] + "Object2c");
            }
            ...
            for (int i = 0; i < Mapstate.Length; i++) {
                MapLibs[300 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Tilesc" + Mapstate[i]);
                MapLibs[301 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Tiles30c" + Mapstate[i]);
                MapLibs[302 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Tiles5c" + Mapstate[i]);
                MapLibs[303 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Smtilesc" + Mapstate[i]);
                MapLibs[304 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Housesc" + Mapstate[i]);
                MapLibs[305 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Cliffsc" + Mapstate[i]);
                MapLibs[306 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Dungeonsc" + Mapstate[i]);
                MapLibs[307 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Innersc" + Mapstate[i]);
                MapLibs[308 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Furnituresc" + Mapstate[i]);
                MapLibs[309 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Wallsc" + Mapstate[i]);
                MapLibs[310 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "smObjectsc" + Mapstate[i]);
                MapLibs[311 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Animationsc" + Mapstate[i]);
                MapLibs[312 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Object1c" + Mapstate[i]);
                MapLibs[313 + (i * 15)] =
                    new MLibrary(Settings.DataPath + "Map\\ShandaMir3\\" + "Object2c" + Mapstate[i]);
            }
            ...
            Thread thread = new(LoadGameLibraries) { IsBackground = true };
            thread.Start();
        }

        private static void InitLibrary(ref MLibrary[] library, string path, string toStringValue, string suffix = "") {
            if(!Directory.Exists(path)) {
                Directory.CreateDirectory(path);
            }

            IOrderedEnumerable<string> allFiles = Directory
                .GetFiles(path, "*" + suffix + MLibrary.Extention, SearchOption.TopDirectoryOnly)
                .OrderBy(x => int.Parse(Regex.Match(x, @"\d+").Value));

            string lastFile = allFiles.Count() > 0 ? Path.GetFileName(allFiles.Last()) : "0";

            int count = int.Parse(Regex.Match(lastFile, @"\d+").Value) + 1;
        ...
        private static void LoadGameLibraries() {
            Count = MapLibs.Length + Monsters.Length + Gates.Length + Flags.Length + Siege.Length + Npcs.Length +
                    CArmours.Length +
                    CHair.Length + CWeapons.Length + CWeaponEffect.Length + AArmours.Length + AHair.Length +
                    AWeaponsL.Length + AWeaponsR.Length +
                    ARArmours.Length + ARHair.Length + ARWeapons.Length + ARWeaponsS.Length +
                    CHumEffect.Length + AHumEffect.Length + ARHumEffect.Length + Mounts.Length + Fishing.Length +
                    Pets.Length +
    ...
    public sealed class MLibrary {
        ...
        public FrameSet Frames => _frames;
        ...
        public void Initialize() {
            ...
            try {
                ...
                if(currentVersion < 2) {
                    MessageBox.Show(
                        "Wrong version, expecting lib version: " + LibVersion.ToString() + " found version: " +
                        currentVersion.ToString() + ".", _fileName, MessageBoxButtons.OK, MessageBoxIcon.Error,
                ...
                if(currentVersion >= 3) {
                    ...
                    int frameCount = _reader.ReadInt32();
        ...
        public void Draw(int index, int x, int y) {
            ...
            DXManager.Draw(mi.Image, new Rectangle(0, 0, mi.Width, mi.Height), new Vector3((float)x, (float)y, 0.0F),
                Color.White);
        ...
        public void Draw(int index, Point point, Color colour, bool offSet = false) {
            ...
            if(point.X >= Settings.ScreenWidth || point.Y >= Settings.ScreenHeight || point.X + mi.Width < 0 ||
               point.Y + mi.Height < 0) {
                return;
            }
        ...
        public void Draw(int index, Point point, Size size, Color colour) {
            ...
            if(point.X >= Settings.ScreenWidth || point.Y >= Settings.ScreenHeight || point.X + size.Width < 0 ||
               point.Y + size.Height < 0) {
                return;
            }
            ...
            DXManager.Draw(mi.Image, new Rectangle(0, 0, mi.Width, mi.Height),
                new Vector3((float)point.X / scaleX, (float)point.Y / scaleY, 0.0F), Color.White);
        ...
        public void DrawTinted(int index, Point point, Color colour, Color Tint, bool offSet = false) {
            ...
            if(mi.HasMask) {
                DXManager.Draw(mi.MaskImage, new Rectangle(0, 0, mi.Width, mi.Height),
                    new Vector3((float)point.X, (float)point.Y, 0.0F), Tint);
            }
        ...
        public void DrawUpBlend(int index, Point point) {
            ...
            DXManager.Draw(mi.Image, new Rectangle(0, 0, mi.Width, mi.Height),
                new Vector3((float)point.X, (float)point.Y, 0.0F), Color.White);
    ...
    public sealed class MImage {
        ...
        private static byte[] DecompressImage(byte[] image) {
            using(GZipStream stream = new(new MemoryStream(image), CompressionMode.Decompress)) {
                const int size = 4096;
