...
namespace Client.MirScenes.Dialogs
{
    public sealed class MountDialog : MirImageControl
    {
        ...
        public MountDialog()
        {
            ...
            HelpButton.Click += (o, e) => GameScene.Scene.HelpDialog.DisplayPage(GameLanguage.ClientTextMap[nameof(ClientTextKeys.Mounts)]);
        ...
        private void DrawMountAnimation()
        {
            ...
            else
            {
                ...
                if (item != null)
                {
                    ...
                    MountLoyalty.Text = string.Format(GameLanguage.ClientTextMap[nameof(ClientTextKeys.LoyaltyProgress)], item.CurrentDura, item.MaxDura);
                }
            }
        ...
        public override void Show()
        {
            ...
            if (GameScene.User.MountType < 0)
            {
                MirMessageBox messageBox = new MirMessageBox(GameLanguage.ClientTextMap[nameof(ClientTextKeys.NoMount)], MirMessageBoxButtons.OK);
                messageBox.Show();
                return;
            }
