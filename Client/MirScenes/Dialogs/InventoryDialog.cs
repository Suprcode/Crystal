    ...
    public sealed class InventoryDialog : MirImageControl {
        ...
        public InventoryDialog() {
            ...
            AddButton.Click += (o1, e) => {
                ...
                MirMessageBox messageBox = new(string.Format(GameLanguage.ExtraSlots4, openGold),
        ...
        private void Button_Click(object sender, EventArgs e) {
            if(GameScene.User.Inventory.Length == 46 && sender == ItemButton2) {
                MirMessageBox messageBox = new(GameLanguage.ExtraSlots8, MirMessageBoxButtons.OKCancel);
