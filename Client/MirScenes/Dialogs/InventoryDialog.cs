    ...
    public sealed class InventoryDialog : MirImageControl
    {
        ...
        public InventoryDialog()
        {
            ...
            AddButton.Click += (o1, e) =>
            {
                ...
                MirMessageBox messageBox = new MirMessageBox(string.Format(GameLanguage.ClientTextMap.GetLocalization(ClientTextKeys.ExtraSlots4), openGold), MirMessageBoxButtons.OKCancel);
