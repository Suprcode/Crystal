...
namespace Client.MirScenes.Dialogs {
    public sealed class ItemRentalDialog : MirImageControl {
        ...
        public ItemRentalDialog() {
            ...
            MirImageControl windowTitle = new MirImageControl {
                Index = 0,
                Library = Libraries.Prguse3,
            ...
            MirButton rentedTabButton = new MirButton {
                Index = 2,
                HoverIndex = 2,
            ...
            MirButton borrowedTabButton = new MirButton {
                Index = 3,
            ...
            MirButton rentItemButton = new MirButton {
                Index = 4,
                HoverIndex = 5,
