...
namespace Client.MirScenes.Dialogs {
    public sealed class FriendDialog : MirImageControl {
        ...
        public FriendDialog() {
            ...
            AddButton.Click += (o, e) => {
                ...
                MirInputBox inputBox = new(message);

                inputBox.OKButton.Click += (o1, e1) => {
                    Network.Enqueue(new ClientPacket.AddFriend
            ...
            RemoveButton.Click += (o, e) => {
                ...
                MirMessageBox messageBox =
                    new(string.Format("Are you sure you wish to remove '{0}'?", SelectedFriend.Name),
        ...
        public void Update(bool clearSelection = true) {
            ...
            List<ClientFriend> filteredFriends = new();
            ...
            for (int i = 0; i < Rows.Length; i++) {
                if(i + StartIndex >= filteredFriends.Count) {
                    break;
                }
        ...
        public int FindSelectedIndex() {
            ...
            if(SelectedFriend != null) {
                for (int i = 0; i < Rows.Length; i++) {
                    if(Rows[i] == null || SelectedFriend != Rows[i].Friend) {
                        continue;
                    }
    ...
    public sealed class FriendRow : MirControl {
        ...
        private void FriendRow_BeforeDraw(object sender, EventArgs e) {
            UpdateInterface();
        }
        ...
        protected override void OnMouseEnter() {
            if(Friend == null || Friend.Memo.Length < 1) {
                return;
            }
