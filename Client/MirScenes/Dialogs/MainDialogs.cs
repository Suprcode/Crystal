...
namespace Client.MirScenes.Dialogs {
    public sealed class MainDialog : MirImageControl {
        ...
        public MirButton GameShopButton,
            MenuButton,
            InventoryButton,
            CharacterButton,
            SkillButton,
        ...
        public bool HPOnly => User != null && User.Class == MirClass.Warrior && User.Level < 26;
        ...
        public MainDialog() {
            ...
            LeftCap = new MirImageControl {
                Index = 12,
                Library = Libraries.Prguse,
                Location = new Point(-67, Size.Height - 96),
                Parent = this,
                Visible = false
            };
            RightCap = new MirImageControl {
                Index = 13,
                Library = Libraries.Prguse,
                Location = new Point(1024, Size.Height - 104),
                Parent = this,
                Visible = false
            };
            ...
            QuestButton = new MirButton {
                ...
                Index = 1909,
                Library = Libraries.Prguse,
                Location = new Point(Size.Width - 50, 76),
                Parent = this,
                PressedIndex = 1911,
                Sound = SoundList.ButtonA,
            ...
            OptionButton = new MirButton {
                ...
                Index = 1912,
                Library = Libraries.Prguse,
                Location = new Point(Size.Width - 27, 76),
                Parent = this,
                PressedIndex = 1914,
                Sound = SoundList.ButtonA,
            ...
            MenuButton = new MirButton {
                ...
                Index = 1960,
                Library = Libraries.Prguse,
                Location = new Point(Size.Width - 55, 35),
                Parent = this,
                PressedIndex = 1962,
            ...
            GameShopButton = new MirButton {
                ...
                Index = 826,
                Library = Libraries.Prguse,
                Location = new Point(Size.Width - 105, 35),
                Parent = this,
                PressedIndex = 828,
                Sound = SoundList.ButtonC,
            ...
            GoldLabel = new MirLabel {
                ...
                Location = new Point(Size.Width - 105, 119),
                Parent = this,
                Size = new Size(99, 13),
            ...
            WeightBar = new MirImageControl {
                Index = 76,
                Library = Libraries.Prguse,
                Location = new Point(Size.Width - 105, 103),
                Parent = this,
                DrawImage = false,
                NotControl = true
            };
            ...
            WeightLabel = new MirLabel {
                Parent = this,
                Location = new Point(Size.Width - 105, 101),
                Size = new Size(40, 14)
            };

            SpaceLabel = new MirLabel {
                Parent = this,
                Location = new Point(Size.Width - 30, 101),
                Size = new Size(26, 14)
            };
            ...
            HeroSummonButton = new MirButton {
                ...
                Library = Libraries.Prguse,
                Parent = this,
                Location = new Point(Size.Width - 160, 90),
                Size = new Size(20, 20),
                Sound = SoundList.ButtonA,
                Visible = false
            };
        ...
        private void HealthOrb_BeforeDraw(object sender, EventArgs e) {
            ...
            Rectangle r = new(0, 80 - height, hpOnly ? 100 : 50, height);
            Libraries.Prguse.Draw(orbImage, r,
                new Point((Settings.ScreenWidth / 2) - (Size.Width / 2), HealthOrb.DisplayLocation.Y + 80 - height),
                Color.White, false);
            ...
            Libraries.Prguse.Draw(4, r,
                new Point((Settings.ScreenWidth / 2) - (Size.Width / 2) + 51,
                    HealthOrb.DisplayLocation.Y + 80 - height), Color.White, false);
        }
    ...
    public sealed class ChatDialog : MirImageControl {
        public List<ChatHistory> FullHistory = new();
        public List<ChatHistory> History = new();
        public List<MirLabel> ChatLines = new();

        public List<ChatItem> LinkedItems = new();
        public List<MirLabel> LinkedItemButtons = new();
        ...
        public Font ChatFont = new(Settings.FontName, 8F);
        ...
        private void PositionBar_OnMoving(object sender, MouseEventArgs e) {
            ...
            if(y >= 16 + CountBar.Size.Height - PositionBar.Size.Height) {
                y = 16 + CountBar.Size.Height - PositionBar.Size.Height;
            }
        ...
        public void ReceiveChat(string text, ChatType type) {
            ...
            for (int i = 1; i < text.Length; i++) {
                ...
                if(TextRenderer.MeasureText(CMain.Graphics, text.Substring(index, i - index), ChatFont).Width >
                   chatWidth) {
                    ...
                    IEnumerable<Match> itemLinkMatches =
                        RegexFunctions.ChatItemLinks.Matches(text.Substring(index)).Cast<Match>();

                    if(itemLinkMatches.Any()) {
                        Match match = itemLinkMatches.SingleOrDefault(x =>
                            x.Index < i - index && x.Index + x.Length > offset - 1);
            ...
            for (int i = 0; i < chat.Count; i++) {
                FullHistory.Add(new ChatHistory
                    { Text = chat[i], BackColour = backColour, ForeColour = foreColour, Type = type });
            }
        ...
        public void Update() {
            ...
            for (int i = StartIndex; i < History.Count; i++) {
                ...
                foreach(Match match in RegexFunctions.ChatItemLinks.Matches(currentLine).Cast<Match>()
                    ...
                    try {
                        ...
                        Size size = TextRenderer.MeasureText(CMain.Graphics, text, temp.Font, temp.Size,
        ...
        private void ChatPanel_MouseWheel(object sender, MouseEventArgs e) {
            ...
            if(StartIndex == History.Count - 1 && count <= 0) {
                return;
            }
        ...
        public ChatControlBar() {
            ...
            SizeButton.Click += (o, e) => {
                ...
                if(GameScene.Scene.BeltDialog.Index == 1932) {
                    GameScene.Scene.BeltDialog.Location = new Point(GameScene.Scene.MainDialog.Location.X + 230,
                        Location.Y - GameScene.Scene.BeltDialog.Size.Height);
                }
            };
    ...
    public sealed class SkillBarDialog : MirImageControl {
        ...
        public MirLabel BindNumberLabel = new();
        ...
        private void SkillBar_OnMoving(object sender, MouseEventArgs e) {
            if(BarIndex * 2 >= Settings.SkillbarLocation.Length) {
                return;
            }
        ...
        public void Update() {
            HasSkill = false;
            foreach(ClientMagic m in GameScene.User.Magics) {
            ...
            for (int i = 1; i <= 8; i++) {
                ...
                foreach(ClientMagic m in GameScene.User.Magics) {
                    ...
                    Cells[i - 1].Hint = string.Format("{0}\nMP: {1}\nCooldown: {2}\nKey: {3}", magic.Name,
                        magic.BaseCost + (magic.LevelCost * magic.Level),
                        Functions.PrintTimeSpanFromMilliSeconds(magic.Delay), key);
    ...
    public sealed class MiniMapDialog : MirImageControl {
        ...
        public List<MirLabel> QuestIcons = new();
        ...
        private void MiniMap_BeforeDraw(object sender, EventArgs e) {
            foreach(MirLabel icon in QuestIcons) {
                icon.Dispose();
            }
            ...
            Rectangle viewRect = new(0, 0, 120, 108);
            ...
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                if((GroupDialog.GroupList.Contains(ob.Name) && MapObject.User != ob) ||
        ...
        public void Process() {
            ...
            GameScene.Scene.MainDialog.SModeLabel.Location = new Point(
                GameScene.Scene.MiniMapDialog.Location.X - 3 - GameScene.Scene.MainDialog.Location.X,
                GameScene.Scene.MiniMapDialog.Size.Height + 150 - Settings.ScreenHeight);
            GameScene.Scene.MainDialog.AModeLabel.Location = new Point(
                GameScene.Scene.MiniMapDialog.Location.X - 3 - GameScene.Scene.MainDialog.Location.X,
                GameScene.Scene.MiniMapDialog.Size.Height + 165 - Settings.ScreenHeight);
            GameScene.Scene.MainDialog.PModeLabel.Location = new Point(
                GameScene.Scene.MiniMapDialog.Location.X - 3 - GameScene.Scene.MainDialog.Location.X,
        ...
        public InspectDialog() {
            ...
            CharacterPage.AfterDraw += (o, e) => {
                ...
                if(ArmorCell.Item != null) {
                    ...
                    if(RealItem.Effect > 0) {
                        ...
                        Libraries.Prguse2.DrawBlend(1200 + wingOffset + genderOffset,
                            new Point(DisplayLocation.X, DisplayLocation.Y - 20), Color.White, true, 1F);
                    }
                }
                ...
                if(HelmetCell.Item != null) {
                    Libraries.StateItems.Draw(HelmetCell.Item.Info.Image,
                        new Point(DisplayLocation.X, DisplayLocation.Y - 20), Color.White, true, 1F);
                } else {
                    ...
                    Libraries.Prguse.Draw(hair,
                        new Point(DisplayLocation.X + offSetX, DisplayLocation.Y + offSetY - 20), Color.White, true,
                        1F);
                }
            };
    ...
    public sealed class OptionDialog : MirImageControl {
        ...
        private void ToggleObserve(bool allow) {
            if(GameScene.AllowObserve == allow) {
                return;
            }
        ...
        private void SoundBar_MouseMove(object sender, MouseEventArgs e) {
            ...
            VolumeBar.Location = percent > 0
                ? new Point(159 + (int)((SoundBar.Size.Width - 2) * percent), 218)
                : new Point(159, 218);
        }
        ...
        private void MusicSoundBar_BeforeDraw(object sender, EventArgs e) {
            ...
            if(percent > 0) {
                ...
                MusicSoundBar.Library.Draw(MusicSoundBar.Index, section, MusicSoundBar.DisplayLocation, Color.White,
                    false);
        ...
        private void MusicSoundBar_MouseMove(object sender, MouseEventArgs e) {
            ...
            MusicVolumeBar.Location = percent > 0
                ? new Point(159 + (int)((MusicSoundBar.Size.Width - 2) * percent), 244)
                : new Point(159, 244);
        }
    ...
    public sealed class MenuDialog : MirImageControl {
        ...
        public MenuDialog() {
            ...
            Library = Libraries.Title;
            Location = new Point(Settings.ScreenWidth - Size.Width,
                GameScene.Scene.MainDialog.Location.Y - Size.Height + 15);
            Sort = true;
            Visible = false;
            Movable = true;
    ...
    public sealed class MagicButton : MirControl {
        ...
        private string[] Prefixes = new string[] { "", "CTRL", "Shift" };
        ...
        public void Update(ClientMagic magic) {
            ...
            KeyLabel.Text = Magic.Key == 0
                ? string.Empty
                : string.Format("{0}{1}F{2}",
                    Prefixes[(Magic.Key - 1) / 8],
                    Magic.Key > 8 ? Environment.NewLine : string.Empty,
                    ((Magic.Key - 1) % 8) + 1);

            switch (magic.Spell) { //Warrior
                case Spell.Fencing:
                    SkillButton.Hint = string.Format(
                        "Fencing \n\nHitting accuracy will be increased in accordance\nwith practice level.\nPassive Skill\nCurrent Skill Level {0}\nNext Level {1}",
                        Magic.Level,
                        Magic.Level == 0 ? Magic.Level1 :
                        Magic.Level == 1 ? Magic.Level2 :
                        Magic.Level == 2 ? Magic.Level3 : 0);
                    break;
                case Spell.Slaying:
                    SkillButton.Hint = string.Format(
                ...
                case Spell.Rage:
                    SkillButton.Hint = string.Format(
                        ...
                        Magic.Level == 0 ? Magic.Level1 :
                        Magic.Level == 1 ? Magic.Level2 :
                        Magic.Level == 2 ? Magic.Level3 : 0, Magic.BaseCost);
                    break;
    ...
    public sealed class DuraStatusDialog : MirImageControl {
        ...
        public DuraStatusDialog() {
            Size = new Size(40, 19);
            Location = new Point(GameScene.Scene.MiniMapDialog.Location.X + 86,
                GameScene.Scene.MiniMapDialog.Size.Height);
    ...
    public sealed class CharacterDuraPanel : MirImageControl {
        public MirImageControl GrayBackground,
            Background,
            Helmet,
            Armour,
            Belt,
        ...
        public CharacterDuraPanel() {
            ...
            Helmet = new MirImageControl() {
                Index = -1, Library = Libraries.Prguse, Parent = Background, Size = new Size(12, 12),
                Location = new Point(24, 3)
            };
            Belt = new MirImageControl() {
                Index = -1, Library = Libraries.Prguse, Parent = Background, Size = new Size(12, 7),
                Location = new Point(23, 23)
            };
            Armour = new MirImageControl() {
                Index = -1, Library = Libraries.Prguse, Parent = Background, Size = new Size(28, 32),
                Location = new Point(16, 11)
            };
            Boots = new MirImageControl() {
                Index = -1, Library = Libraries.Prguse, Parent = Background, Size = new Size(24, 9),
                Location = new Point(17, 43)
            };
            Weapon = new MirImageControl() {
                Index = -1, Library = Libraries.Prguse, Parent = Background, Size = new Size(12, 33),
            ...
            LeftBracelet = new MirImageControl() {
                Index = -1, Library = Libraries.Prguse, Parent = Background, Size = new Size(12, 8),
            ...
            RightRing = new MirImageControl() {
                Index = -1, Library = Libraries.Prguse, Parent = Background, Size = new Size(12, 12),
                Location = new Point(43, 54)
            };
            Torch = new MirImageControl() {
                Index = -1, Library = Libraries.Prguse, Parent = Background, Size = new Size(8, 32),
            ...
            Mount = new MirImageControl() {
                Index = -1, Library = Libraries.Prguse, Parent = Background, Size = new Size(12, 12),
                Location = new Point(43, 68)
            };
            Item1 = new MirImageControl() {
                Index = -1, Library = Libraries.Prguse, Parent = Background, Size = new Size(8, 12),
                Location = new Point(19, 67)
            };
        ...
        public void GetCharacterDura() {
            if(GameScene.Scene.CharacterDialog.Grid[0].Item == null) {
                Weapon.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[1].Item == null) {
                Armour.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[2].Item == null) {
                Helmet.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[3].Item == null) {
                Torch.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[4].Item == null) {
                Necklace.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[5].Item == null) {
                LeftBracelet.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[6].Item == null) {
                RightBracelet.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[7].Item == null) {
                LeftRing.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[8].Item == null) {
                RightRing.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[9].Item == null) {
                Amulet.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[10].Item == null) {
                Belt.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[11].Item == null) {
                Boots.Index = -1;
            }

            if(GameScene.Scene.CharacterDialog.Grid[12].Item == null) {
                Stone.Index = -1;
            }

            for (int i = 0; i < MapObject.User.Equipment.Length; i++) {
                if(MapObject.User.Equipment[i] == null) {
                    continue;
                }
        ...
        public void UpdateCharacterDura(UserItem item) {
            ...
            switch (item.Info.Type) {
                ...
                case ItemType.Bracelet:
                    if(GameScene.Scene.CharacterDialog.Grid[(byte)EquipmentSlot.BraceletR].Item != null &&
                       item.UniqueID == GameScene.Scene.CharacterDialog.Grid[(byte)EquipmentSlot.BraceletR].Item
                           .UniqueID) {
                        if(item.CurrentDura > Warning) {
                    ...
                    } else if(GameScene.Scene.CharacterDialog.Grid[(byte)EquipmentSlot.BraceletL].Item != null &&
                              item.UniqueID == GameScene.Scene.CharacterDialog.Grid[(byte)EquipmentSlot.BraceletL].Item
                                  .UniqueID) {
                        if(item.CurrentDura > Warning) {
                ...
                case ItemType.Necklace:
                    ...
                    break;
                case ItemType.Ring:
                    if(GameScene.Scene.CharacterDialog.Grid[(byte)EquipmentSlot.RingR].Item != null && item.UniqueID ==
                       GameScene.Scene.CharacterDialog.Grid[(byte)EquipmentSlot.RingR].Item.UniqueID) {
                        if(item.CurrentDura > Warning) {
                    ...
                    } else if(GameScene.Scene.CharacterDialog.Grid[(byte)EquipmentSlot.RingL].Item != null &&
                              item.UniqueID == GameScene.Scene.CharacterDialog.Grid[(byte)EquipmentSlot.RingL].Item
                                  .UniqueID) {
                        if(item.CurrentDura > Warning) {
                            LeftRing.Index = 2131;
                        }
