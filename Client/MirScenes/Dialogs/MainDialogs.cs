    ...
    public sealed class MenuDialog : MirImageControl
    {
        ...
        public MenuDialog()
        {
            ...
            */
            ...
            {
                //if (GameScene.Scene.CodexDialog.Visible)
                //    GameScene.Scene.CodexDialog.Hide();  //read for codex implementation
                //else GameScene.Scene.CodexDialog.Show();
            };
