...
namespace Client.MirScenes.Dialogs
{
    public sealed class IntelligentCreatureDialog : MirImageControl
    {
        ...
        private void BlackStoneImageFG_AfterDraw(object sender, EventArgs e)
        {
            ...
            if (HoverLabel.Visible && HoverLabelParent != null && HoverLabelParent == BlackStoneImageFG)
            {
                if (GameScene.User.IntelligentCreatures[selectedCreature].CreatureRules.CanProduceBlackStone)
                    ...
                    HoverLabel.Text = GameLanguage.ClientTextMap[nameof(ClientTextKeys.NoProduction)];
            }
        ...
        private void Control_MouseEnter(object sender, EventArgs e)
        {
            ...
            if (sender == FullnessMin)
            {
                ...
                HoverLabel.Text = string.Format(GameLanguage.ClientTextMap[nameof(ClientTextKeys.NeededBy)], GameScene.User.IntelligentCreatures[selectedCreature].CreatureRules.MinimalFullness.ToString());
        ...
        private void ButtonClick(object sender, EventArgs e)
        {
            ...
            {
                MirInputBox inputBox = new MirInputBox(GameLanguage.ClientTextMap[nameof(ClientTextKeys.PleaseEnterCreatureNewName)]);
                ...
                inputBox.OKButton.Click += (o1, e1) =>
                {
                    ...
                    {
                        MirMessageBox failedMessage = new MirMessageBox(string.Format(GameLanguage.ClientTextMap[nameof(ClientTextKeys.CreatureNameLengthRange)], Globals.MinCharacterNameLength, Globals.MaxCharacterNameLength), MirMessageBoxButtons.OK);
                        failedMessage.Show();
                    }
                    else
                    {
            ...
            {
                MirInputBox verificationBox = new MirInputBox(GameLanguage.ClientTextMap[nameof(ClientTextKeys.EnterCreatureNameForVerification)]);
                verificationBox.OKButton.Click += (o1, e1) =>
                {
                    ...
                    {
                        GameScene.Scene.ChatDialog.ReceiveChat(GameLanguage.ClientTextMap[nameof(ClientTextKeys.VerificationFailed)], ChatType.System);
                    }
                    else
                    {
        ...
        private void DrawCreatureAnimation()
        {
            ...
            CreatureInfo.Text = string.Format(GameLanguage.ClientTextMap[nameof(ClientTextKeys.CanPickupItems)], semi, mouse);
            CreatureInfo1.Text = rules.CanProduceBlackStone ? GameLanguage.ClientTextMap[nameof(ClientTextKeys.CanProduceBlackStones)] : "";
            CreatureInfo2.Text = rules.CanProduceBlackStone ? GameLanguage.ClientTextMap[nameof(ClientTextKeys.CanProducePearlsBuyCreatureItems)] : "";

            //Expire
            if (GameScene.User.IntelligentCreatures[selectedCreature].Expire == DateTime.MinValue)
            {
                CreatureDeadline.Text = string.Format(GameLanguage.ClientTextMap[nameof(ClientTextKeys.ExpireNever)]);
            }
            else
            {
                var seconds = (GameScene.User.IntelligentCreatures[selectedCreature].Expire - CMain.Now).TotalSeconds;

                CreatureDeadline.Text = string.Format(GameLanguage.ClientTextMap[nameof(ClientTextKeys.Expire)], Functions.PrintTimeSpanFromSeconds(seconds));
            }

            if (GameScene.User.IntelligentCreatures[selectedCreature].MaintainFoodTime == 0)
                CreatureMaintainFoodBuff.Text = "0";
            else
                CreatureMaintainFoodBuff.Text = string.Format(GameLanguage.ClientTextMap[nameof(ClientTextKeys.FoodBuff)], Functions.PrintTimeSpanFromSeconds(GameScene.User.IntelligentCreatures[selectedCreature].MaintainFoodTime));
        ...
        public override void Show()
        {
            ...
            {
                MirMessageBox messageBox = new MirMessageBox(GameLanguage.ClientTextMap[nameof(ClientTextKeys.NoCreatures)], MirMessageBoxButtons.OK);
                messageBox.Show();
                return;
            }
    ...
    public sealed class IntelligentCreatureOptionsDialog : MirImageControl
    {
        ...
        {
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.AllItems)],
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Gold)],
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Weapons)], 
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Armours)],
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Helmets)], 
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Boots)], 
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Belts)], 
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Jewelry)], 
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Others)]
        };
    ...
    public sealed class IntelligentCreatureOptionsGradeDialog : MirImageControl
    {
        ...
        {
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.All)], 
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Common)], 
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Rare)], 
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Mythical)],
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Legendary)], 
            GameLanguage.ClientTextMap[nameof(ClientTextKeys.Heroic)]
        };
