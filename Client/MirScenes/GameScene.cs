...
namespace Client.MirScenes {
    public sealed class GameScene : MirScene {
        ...
        public List<ParticleEngine> ParticleEngines = new();
        ...
        public List<SkillBarDialog> SkillBarDialogs = new();
        ...
        public static List<ItemInfo> ItemInfoList = new();
        public static List<UserId> UserIdList = new();
        public static List<UserItem> ChatItemList = new();
        public static List<ClientQuestInfo> QuestInfoList = new();
        public static List<GameShopItem> GameShopInfoList = new();
        public static List<ClientRecipeInfo> RecipeInfoList = new();
        public static Dictionary<int, BigMapRecord> MapInfoList = new();
        public static List<ClientHeroInformation> HeroInfoList = new();
        public static ClientHeroInformation[] HeroStorage = new ClientHeroInformation[8];
        public static Dictionary<long, RankCharacterInfo> RankingList = new();
        ...
        public List<OutPutMessage> OutputMessages = new();
        ...
        public GameScene() {
            ...
            SkillBarDialog Bar1 = new() { Parent = this, Visible = false, BarIndex = 0 };
            SkillBarDialogs.Add(Bar1);
            SkillBarDialog Bar2 = new() { Parent = this, Visible = false, BarIndex = 1 };
            ...
            BuffsDialog = new BuffDialog {
                Parent = this,
                Visible = true,
                GetExpandedParameter = () => {
                    return Settings.ExpandedBuffWindow;
                },
                SetExpandedParameter = (value) => {
        ...
        private void UpdateMouseCursor() {
            ...
            if(HoverItem != null) {
                if(SelectedCell != null && SelectedCell.Item != null && SelectedCell.Item.Info.Type == ItemType.Gem &&
                   CMain.Ctrl) {
            ...
            foreach(KeyBind KeyCheck in CMain.InputKeys.Keylist) {
                ...
                switch (KeyCheck.function) {
                    ...
                    case KeybindOptions.Bar2Skill8:
                        UseSpell(16);
                        break;
                    case KeybindOptions.HeroSkill1:
                        UseSpell(17);
                        break;
                    case KeybindOptions.HeroSkill2:
                        UseSpell(18);
                        break;
                    case KeybindOptions.HeroSkill3:
                        UseSpell(19);
                        break;
                    case KeybindOptions.HeroSkill4:
                        UseSpell(20);
                        break;
                    case KeybindOptions.HeroSkill5:
                        UseSpell(21);
                        break;
                    case KeybindOptions.HeroSkill6:
                        UseSpell(22);
                        break;
                    case KeybindOptions.HeroSkill7:
                        UseSpell(23);
                        break;
                    case KeybindOptions.HeroSkill8:
                        UseSpell(24);
                        break;
                    ...
                    case KeybindOptions.HeroInventory:
                        ...
                        if(!HeroInventoryDialog.Visible) {
                            HeroInventoryDialog.Show();
                        } else {
                    ...
                    case KeybindOptions.Creature:
                        if(!IntelligentCreatureDialog.Visible) {
                    ...
                    case KeybindOptions.CreatureAutoPickup: //semiauto!
                        Network.Enqueue(new ClientPacket.IntelligentCreaturePickup
                            { MouseMode = false, Location = MapControl.MapLocation });
                        break;
                    case KeybindOptions.CreaturePickup:
                        Network.Enqueue(new ClientPacket.IntelligentCreaturePickup
                            { MouseMode = true, Location = MapControl.MapLocation });
                        break;
                    ...
                    case KeybindOptions.Keybind:
                        if(!KeyboardLayoutDialog.Visible) {
        ...
        public void ChangeSkillMode(bool? ctrl) {
            if(Settings.SkillMode || ctrl == true) {
                ...
                Scene.ChatDialog.ReceiveChat("[SkillMode Ctrl]", ChatType.Hint);
                Scene.OptionDialog.ToggleSkillButtons(true);
            } else if(!Settings.SkillMode || ctrl == false) {
                Settings.SkillMode = true;
                Scene.ChatDialog.ReceiveChat("[SkillMode ~]", ChatType.Hint);
        ...
        public void UseSpell(int key) {
            ...
            if(actor.Dead || actor.RidingMount || actor.Fishing) {
                return;
            }
            ...
            if(CMain.Time < actor.BlizzardStopTime || CMain.Time < actor.ReincarnationStopTime) {
                return;
            }
                ...
                case Spell.CounterAttack:
                    if(CMain.Time < magic.CastTime + magic.Delay) {
                        if(CMain.Time >= OutputDelay) {
                            ...
                            Scene.OutputMessage(string.Format("You cannot cast {0} for another {1} seconds.",
                                magic.Spell.ToString(), ((magic.CastTime + magic.Delay - CMain.Time - 1) / 1000) + 1));
                        }
            ...
            switch (magic.Spell) {
                ...
                case Spell.Thrusting:
                    ...
                    ChatDialog.ReceiveChat(prefix + (actor.Thrusting ? "Use Thrusting." : "Do not use Thrusting."),
                        ChatType.Hint);
                ...
                case Spell.HalfMoon:
                    ...
                    ChatDialog.ReceiveChat(prefix + (actor.HalfMoon ? "Use Half Moon." : "Do not use Half Moon."),
                        ChatType.Hint);
                    ToggleTime = CMain.Time + 1000;
                ...
                case Spell.CrossHalfMoon:
                    ...
                    ChatDialog.ReceiveChat(
                        prefix + (actor.CrossHalfMoon ? "Use Cross Half Moon." : "Do not use Cross Half Moon."),
                        ChatType.Hint);
                    ToggleTime = CMain.Time + 1000;
                ...
                case Spell.DoubleSlash:
                    ...
                    ChatDialog.ReceiveChat(
                        prefix + (actor.DoubleSlash ? "Use Double Slash." : "Do not use Double Slash."), ChatType.Hint);
                    ToggleTime = CMain.Time + 1000;
        ...
        public void QuitGame() {
            if(CMain.Time >= LogTime) {
                ...
                MirMessageBox messageBox = new(GameLanguage.ExitTip, MirMessageBoxButtons.YesNo);
                messageBox.YesButton.Click += (o, e) => Program.Form.Close();
                messageBox.Show();
            } else {
                ChatDialog.ReceiveChat(string.Format(GameLanguage.CannotLeaveGame, (LogTime - CMain.Time) / 1000),
                    ChatType.System);
            }
        }
        ...
        public void LogOut() {
            if(CMain.Time >= LogTime) {
                //If Last Combat < 10 CANCEL
                MirMessageBox messageBox = new(GameLanguage.LogOutTip, MirMessageBoxButtons.YesNo);
        ...
        public override void Process() {
            ...
            if(ShowReviveMessage && CMain.Time > User.DeadTime && User.CurrentAction == MirAction.Dead) {
                ShowReviveMessage = false;
                MirMessageBox messageBox = new(GameLanguage.DiedTip, MirMessageBoxButtons.YesNo, false);

                messageBox.YesButton.Click += (o, e) => {
                    if(User.Dead) {
                        Network.Enqueue(new ClientPacket.TownRevive());
                    }
                };
        ...
        public void DialogProcess() {
            ...
            for (int i = 0; i < Scene.SkillBarDialogs.Count; i++) {
                if(i * 2 > Settings.SkillbarLocation.Length) {
                    break;
                }
                ...
                Scene.SkillBarDialogs[i].Location =
                    new Point(Settings.SkillbarLocation[i, 0], Settings.SkillbarLocation[i, 1]);
            }
        ...
        private void MapInformation(ServerPacket.MapInformation p) {
            ...
            MapControl = new MapControl {
                Index = p.MapIndex, FileName = Path.Combine(Settings.MapPath, p.FileName + ".map"), Title = p.Title,
                MiniMap = p.MiniMap, BigMap = p.BigMap, Lights = p.Lights, Lightning = p.Lightning, Fire = p.Fire,
                MapDarkLight = p.MapDarkLight, Music = p.Music
            };
        ...
        private void NewMapInfo(ServerPacket.NewMapInfo info) {
            BigMapRecord newRecord = new() { Index = info.MapIndex, MapInfo = info.Info };
        ...
        private void CreateBigMapButtons(BigMapRecord record) {
            ...
            foreach(ClientNpcInfo npcInfo in record.MapInfo.Npcs) {
                BigMapNpcRow row = new(npcInfo) { Parent = BigMapDialog };
                record.NpcButtons.Add(row);
            }
        }

        private void RecreateBigMapButtons() {
            foreach(BigMapRecord record in MapInfoList.Values) {
        ...
        private void SearchMapResult(ServerPacket.SearchMapResult info) {
            if(info.MapIndex == -1 && info.NpcIndex == 0) {
                MirMessageBox messageBox = new("Nothing Found.", MirMessageBoxButtons.OK);
        ...
        private void ObjectPlayer(ServerPacket.ObjectPlayer p) {
            PlayerObject player = new(p.ObjectID);
            player.Load(p);
        }

        private void ObjectHero(ServerPacket.ObjectHero p) {
            HeroObject hero = new(p.ObjectID);
            hero.Load(p);
        ...
        private void ObjectTurn(ServerPacket.ObjectTurn p) {
            if(p.ObjectID == User.ObjectID && !Observing) {
                return;
            }
            ...
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                ob.ActionFeed.Add(new QueuedAction
                    { Action = MirAction.Standing, Direction = p.Direction, Location = p.Location });
                return;
            }
        }
        ...
        private void MoveItem(ServerPacket.MoveItem p) {
            ...
            switch (p.Grid) {
                case MirGridType.Inventory:
                    fromCell = p.From < User.BeltIdx
                        ? BeltDialog.Grid[p.From]
                        : InventoryDialog.Grid[p.From - User.BeltIdx];
                    break;
                ...
                case MirGridType.HeroInventory:
                    fromCell = p.From < User.HeroBeltIdx
                        ? HeroBeltDialog.Grid[p.From]
                        : HeroInventoryDialog.Grid[p.From - User.HeroBeltIdx];
                    break;
                default:
                    return;
            }
            ...
            switch (p.Grid) {
                ...
                case MirGridType.Refine:
                    ...
                    break;
                case MirGridType.HeroInventory:
                    toCell = p.To < User.HeroBeltIdx
                        ? HeroBeltDialog.Grid[p.To]
                        : HeroInventoryDialog.Grid[p.To - User.HeroBeltIdx];
                    break;
                default:
                    return;
            }
        ...
        private void RemoveItem(ServerPacket.RemoveItem p) {
            ...
            for (int i = 0; i < MapObject.User.Equipment.Length; i++) {
                if(MapObject.User.Equipment[i] == null || MapObject.User.Equipment[i].UniqueID != p.UniqueID) {
                    continue;
                }
            ...
            if(index == -1 && Hero != null) {
                for (int i = 0; i < MapObject.Hero.Equipment.Length; i++) {
                    if(MapObject.Hero.Equipment[i] == null || MapObject.Hero.Equipment[i].UniqueID != p.UniqueID) {
                        continue;
                    }
        ...
        private void TakeBackItem(ServerPacket.TakeBackItem p) {
            ...
            MirItemCell toCell =
                p.To < User.BeltIdx ? BeltDialog.Grid[p.To] : InventoryDialog.Grid[p.To - User.BeltIdx];
        ...
        private void StoreItem(ServerPacket.StoreItem p) {
            MirItemCell fromCell = p.From < User.BeltIdx
                ? BeltDialog.Grid[p.From]
                : InventoryDialog.Grid[p.From - User.BeltIdx];
        ...
        private void SplitItem(ServerPacket.SplitItem p) {
            ...
            if(p.Grid == MirGridType.Inventory && (p.Item.Info.Type == ItemType.Potion ||
                                                   p.Item.Info.Type == ItemType.Scroll ||
                                                   p.Item.Info.Type == ItemType.Amulet ||
        ...
        private void TakeBackHeroItem(ServerPacket.TakeBackHeroItem p) {
            MirItemCell fromCell = p.From < User.HeroBeltIdx
                ? HeroBeltDialog.Grid[p.From]
                : HeroInventoryDialog.Grid[p.From - User.HeroBeltIdx];
        ...
        private void TransferHeroItem(ServerPacket.TransferHeroItem p) {
            ...
            MirItemCell toCell = p.To < User.HeroBeltIdx
                ? HeroBeltDialog.Grid[p.To]
                : HeroInventoryDialog.Grid[p.To - User.HeroBeltIdx];
        ...
        private void ShareQuest(ServerPacket.ShareQuest p) {
            ...
            MirMessageBox messageBox =
                new(string.Format("{0} would like to share a quest with you. Do you accept?", p.SharerName),
                    MirMessageBoxButtons.YesNo);

            messageBox.YesButton.Click += (o, e) => Network.Enqueue(new ClientPacket.AcceptQuest
                { NpcIndex = 0, QuestIndex = quest.Index });
        ...
        private void ObjectMonster(ServerPacket.ObjectMonster p) {
            bool found = false;
            MonsterObject mob = (MonsterObject)MapControl.Objects.Find(ob => ob.ObjectID == p.ObjectID);
            if(mob != null) {
                found = true;
            }
            ...
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                if(ob.Race == ObjectType.Player) {
                    action = new QueuedAction {
                        Action = MirAction.Attack1, Direction = p.Direction, Location = p.Location,
                    ...
                    switch (p.Type) {
                        ...
                        case 1: {
                            action = new QueuedAction {
                                Action = MirAction.Attack2, Direction = p.Direction, Location = p.Location,
                                Params = new List<object>()
                            };
                            break;
                        }
                        case 2: {
                            action = new QueuedAction {
                                Action = MirAction.Attack3, Direction = p.Direction, Location = p.Location,
                                Params = new List<object>()
                            };
                            break;
                        }
                        case 3: {
                            action = new QueuedAction {
                                Action = MirAction.Attack4, Direction = p.Direction, Location = p.Location,
                                Params = new List<object>()
                            };
                            break;
                        }
                        case 4: {
                            action = new QueuedAction {
                                Action = MirAction.Attack5, Direction = p.Direction, Location = p.Location,
                                Params = new List<object>()
                            };
                            break;
                        }
        ...
        private void Struck(ServerPacket.Struck p) {
                ...
                for (int j = 0; j < User.Effects.Count; j++) {
                    ...
                    if(effect != null && effect.BuffType == BuffType.EnergyShield) {
                        ...
                        User.Effects.Add(effect =
                            new BuffEffect(Libraries.Magic2, 1890, 6, 600, User, true, BuffType.EnergyShield)
                                { Repeat = false });
                        SoundManager.PlaySound(20000 + ((ushort)Spell.EnergyShield * 10) + 1);

                        effect.Complete += (o, e) => {
                            User.Effects.Add(new BuffEffect(Libraries.Magic2, 1900, 2, 800, User, true,
                                BuffType.EnergyShield) { Repeat = true });
                        };
            ...
            QueuedAction action = new()
                { Action = MirAction.Struck, Direction = dir, Location = location, Params = new List<object>() };
        ...
        private void ObjectStruck(ServerPacket.ObjectStruck p) {
            ...
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                if(ob.ActionFeed.Count > 0 && ob.ActionFeed[ob.ActionFeed.Count - 1].Action == MirAction.Struck) {
                    return;
                }
                ...
                QueuedAction action = new() {
                    Action = MirAction.Struck, Direction = p.Direction, Location = p.Location,
                    Params = new List<object>()
                };
                action.Params.Add(p.AttackerID);
                ob.ActionFeed.Add(action);
                    ...
                    for (int j = 0; j < ob.Effects.Count; j++) {
                        ...
                        if(effect != null && effect.BuffType == BuffType.EnergyShield) {
                            ...
                            ob.Effects.Add(effect =
                                new BuffEffect(Libraries.Magic2, 1890, 6, 600, ob, true, BuffType.EnergyShield)
                                    { Repeat = false });
                            SoundManager.PlaySound(20000 + ((ushort)Spell.EnergyShield * 10) + 1);

                            effect.Complete += (o, e) => {
                                ob.Effects.Add(new BuffEffect(Libraries.Magic2, 1900, 2, 800, ob, true,
                                    BuffType.EnergyShield) { Repeat = true });
                            };
                    ...
                    switch (p.Type) {
                        case DamageType.Hit: //add damage level colours
                            obj.Damages.Add(new Damage(p.Damage.ToString("#,##0"), 1000,
                                obj.Race == ObjectType.Player ? Color.Red : Color.White, 50));
                            break;
                        case DamageType.Miss:
                            obj.Damages.Add(new Damage("Miss", 1200,
                                obj.Race == ObjectType.Player ? Color.LightCoral : Color.LightGray, 50));
                            break;
                        case DamageType.Critical:
                            obj.Damages.Add(new Damage("Crit", 1000,
        ...
        private void DuraChanged(ServerPacket.DuraChanged p) {
                ...
                for (int i = 0; i < User.Equipment.Length; i++) {
                    ...
                    if(User.Equipment[i] != null && User.Equipment[i].Slots != null) {
                        for (int j = 0; j < User.Equipment[i].Slots.Length; j++) {
                            if(User.Equipment[i].Slots[j] != null &&
                               User.Equipment[i].Slots[j].UniqueID == p.UniqueID) {
            ...
            if(item.CurrentDura == 0) {
                ...
                switch (item.Info.Type) {
                    case ItemType.Mount:
                        ChatDialog.ReceiveChat(string.Format("{0} is no longer loyal to you.", item.Info.FriendlyName),
                            ChatType.System);
                        break;
                    default:
                        ChatDialog.ReceiveChat(string.Format("{0}'s dura has dropped to 0.", item.Info.FriendlyName),
                            ChatType.System);
                        break;
                }
            }
        ...
        private void DeleteQuestItem(ServerPacket.DeleteQuestItem p) {
            for (int i = 0; i < User.QuestInventory.Length; i++) {
                ...
                if(item == null || item.UniqueID != p.UniqueID) {
                    continue;
                }
            ...
            for (int i = 0; i < User.Inventory.Length; i++) {
                ...
                if(item != null && item.Slots.Length > 0) {
                    for (int j = 0; j < item.Slots.Length; j++) {
                        ...
                        if(slotItem == null || slotItem.UniqueID != p.UniqueID) {
                            continue;
                        }
        ...
        private void Death(ServerPacket.Death p) {
            ...
            User.ActionFeed.Add(new QueuedAction
                { Action = MirAction.Die, Direction = p.Direction, Location = p.Location });
        ...
        private void ObjectHarvest(ServerPacket.ObjectHarvest p) {
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                ob.ActionFeed.Add(new QueuedAction
                    { Action = MirAction.Harvest, Direction = ob.Direction, Location = ob.CurrentLocation });
                return;
            }
        }
        ...
        private void ObjectHarvested(ServerPacket.ObjectHarvested p) {
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                ob.ActionFeed.Add(new QueuedAction
                    { Action = MirAction.Skeleton, Direction = ob.Direction, Location = ob.CurrentLocation });
                return;
            }
        }

        private void ObjectNpc(ServerPacket.ObjectNpc p) {
            NpcObject ob = new(p.ObjectID);
            ob.Load(p);
        }
        ...
        private void NpcImageUpdate(ServerPacket.NpcImageUpdate p) {
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                MapObject ob = MapControl.Objects[i];
                if(ob.ObjectID != p.ObjectID || ob.Race != ObjectType.Merchant) {
                    continue;
                }
        ...
        private void ObjectHide(ServerPacket.ObjectHide p) {
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                ob.ActionFeed.Add(new QueuedAction
                    { Action = MirAction.Hide, Direction = ob.Direction, Location = ob.CurrentLocation });
                return;
            }
        }
        ...
        private void ObjectShow(ServerPacket.ObjectShow p) {
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                ob.ActionFeed.Add(new QueuedAction
                    { Action = MirAction.Show, Direction = ob.Direction, Location = ob.CurrentLocation });
                return;
            }
        }

        private void Poisoned(ServerPacket.Poisoned p) {
            PoisonType previousPoisons = User.Poison;

            User.Poison = p.Poison;
            if(p.Poison.HasFlag(PoisonType.Stun) || p.Poison.HasFlag(PoisonType.Dazed) ||
               p.Poison.HasFlag(PoisonType.Frozen) || p.Poison.HasFlag(PoisonType.Paralysis) ||
        ...
        private void MapChanged(ServerPacket.MapChanged p) {
            bool isCurrentMap = MapControl.Index == p.MapIndex;
        ...
        private void ObjectTeleportOut(ServerPacket.ObjectTeleportOut p) {
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                switch (p.Type) {
                    ...
                    case 2: //RedFoxman
                    {
                        effect = new Effect(Libraries.Monsters[(ushort)Monster.RedFoxman], 243, 10, 500,
                            ob.CurrentLocation);
                        break;
                    }
                    case 4: //MutatedManWorm
                    {
                        effect = new Effect(Libraries.Monsters[(ushort)Monster.MutatedManworm], 272, 6, 500,
                            ob.CurrentLocation);
                    ...
                    case 5: //WitchDoctor
                    {
                        effect = new Effect(Libraries.Monsters[(ushort)Monster.WitchDoctor], 328, 20, 1000,
                            ob.CurrentLocation);
                    ...
                    case 6: //TurtleKing
                    {
                        effect = new Effect(Libraries.Monsters[(ushort)Monster.TurtleKing], 946, 10, 500,
                            ob.CurrentLocation);
                        break;
                    }
                    case 7: //Mandrill
                    {
                        effect = new Effect(Libraries.Monsters[(ushort)Monster.Mandrill], 280, 10, 1000,
                            ob.CurrentLocation);
                    ...
                    case 8: //DarkCaptain
                    {
                        ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.DarkCaptain], 1224, 10, 1000,
                            ob.CurrentLocation));
                    ...
                    {
                        MapControl.Effects.Add(effect = new Effect(Libraries.Monsters[(ushort)Monster.HornedCommander],
                            928, 10, 1000, ob.CurrentLocation));
                    ...
                    {
                        MapControl.Effects.Add(effect = new Effect(Libraries.Monsters[(ushort)Monster.SnowWolfKing],
                            561, 10, 1000, ob.CurrentLocation));
                        SoundManager.PlaySound(8455);
                        playDefaultSound = false;
                        break;
                    }
        ...
        private void ObjectTeleportIn(ServerPacket.ObjectTeleportIn p) {
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                switch (p.Type) {
                    ...
                    case 10: //HornedCommander
                    {
                        ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.HornedCommander], 928, 10, 1000,
                            ob));
                        SoundManager.PlaySound(8455);
                        playDefaultSound = false;
                        break;
        ...
        private void NpcRequestInput(ServerPacket.NpcRequestInput p) {
            MirInputBox inputBox = new("Please enter the required information.");

            inputBox.OKButton.Click += (o1, e1) => {
                Network.Enqueue(new ClientPacket.NpcConfirmInput
                    { Value = inputBox.InputTextBox.Text, NpcID = p.NpcID, PageName = p.PageName });
                inputBox.Dispose();
            };
            inputBox.Show();
        }
        ...
        private void ObjectMagic(ServerPacket.ObjectMagic p) {
            if(p.SelfBroadcast == false && p.ObjectID == User.ObjectID && !Observing) {
                return;
            }
            ...
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                QueuedAction action = new() {
                    Action = MirAction.Spell, Direction = p.Direction, Location = p.Location,
                    Params = new List<object>()
                };
                action.Params.Add(p.Spell);
        ...
        private void ObjectProjectile(ServerPacket.ObjectProjectile p) {
            ...
            switch (p.Spell) {
                case Spell.FireBounce: {
                    ...
                    Missile missile =
                        source.CreateProjectile(410, Libraries.Magic, true, 6, 30, 4, targetID: p.Destination);
            ...
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                switch (p.Effect) {
                    ...
                    case SpellEffect.RedMoonEvil:
                        ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.RedMoonEvil], 32, 6, 400, ob)
                            { Blend = false });
                        break;
                    ...
                    case SpellEffect.MagicShieldUp:
                        ...
                        player.Effects.Add(player.ShieldEffect = new Effect(Libraries.Magic, 3890, 3, 600, ob)
                            { Repeat = true });
                        break;
                    ...
                    case SpellEffect.GreatFoxSpirit:
                        ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.GreatFoxSpirit],
                            375 + (CMain.Random.Next(3) * 20), 20, 1400, ob));
                    ...
                    case SpellEffect.ElementalBarrierUp:
                        ...
                        player.Effects.Add(player.ElementalBarrierEffect =
                            new Effect(Libraries.Magic3, 1890, 10, 2000, ob) { Repeat = true });
                        break;
                    case SpellEffect.ElementalBarrierDown:
                        ...
                        player.Effects.Add(player.ElementalBarrierEffect =
                            new Effect(Libraries.Magic3, 1910, 7, 1400, ob));
                    ...
                    case SpellEffect.DelayedExplosion:
                        ...
                        if(effectid < 0) {
                            ...
                            if(DelayedExplosionEffect.effectlist[effectid].stage < p.EffectType) {
                                ...
                                ob.Effects.Add(new DelayedExplosionEffect(Libraries.Magic3,
                                    1590 + ((int)p.EffectType * 10), 8, 1200, ob, true, (int)p.EffectType, 0));
                            }
                        }

                        break;
                    case SpellEffect.AwakeningSuccess: {
                        Effect ef = new(Libraries.Magic3, 900, 16, 1600, ob, CMain.Time + p.DelayTime);
                        ef.Played += (o, e) => SoundManager.PlaySound(50002);
                        ef.Complete += (o, e) => MapControl.AwakeningAction = false;
                        ob.Effects.Add(ef);
                        ob.Effects.Add(new Effect(Libraries.Magic3, 840, 16, 1600, ob, CMain.Time + p.DelayTime)
                            { Blend = false });
                    }
                        break;
                    case SpellEffect.AwakeningFail: {
                        Effect ef = new(Libraries.Magic3, 920, 9, 900, ob, CMain.Time + p.DelayTime);
                        ef.Played += (o, e) => SoundManager.PlaySound(50003);
                        ef.Complete += (o, e) => MapControl.AwakeningAction = false;
                        ob.Effects.Add(ef);
                        ob.Effects.Add(new Effect(Libraries.Magic3, 860, 9, 900, ob, CMain.Time + p.DelayTime)
                            { Blend = false });
                    }
                        break;
                    case SpellEffect.AwakeningHit: {
                        Effect ef = new(Libraries.Magic3, 880, 5, 500, ob, CMain.Time + p.DelayTime);
                        ef.Played += (o, e) => SoundManager.PlaySound(50001);
                        ob.Effects.Add(ef);
                        ob.Effects.Add(new Effect(Libraries.Magic3, 820, 5, 500, ob, CMain.Time + p.DelayTime)
                            { Blend = false });
                    }
                        break;
                    case SpellEffect.AwakeningMiss: {
                        Effect ef = new(Libraries.Magic3, 890, 5, 500, ob, CMain.Time + p.DelayTime);
                        ef.Played += (o, e) => SoundManager.PlaySound(50000);
                        ob.Effects.Add(ef);
                        ob.Effects.Add(new Effect(Libraries.Magic3, 830, 5, 500, ob, CMain.Time + p.DelayTime)
                            { Blend = false });
                    }
                        break;
                    case SpellEffect.TurtleKing: {
                        Effect ef = new(Libraries.Monsters[(ushort)Monster.TurtleKing],
                            CMain.Random.Next(2) == 0 ? 922 : 934, 12, 1200, ob);
                        ef.Played += (o, e) => SoundManager.PlaySound(20000 + ((ushort)Spell.HellFire * 10) + 1);
                        ob.Effects.Add(ef);
                    }
                        break;
                    case SpellEffect.Behemoth: {
                        MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Behemoth], 788, 10, 1500,
                            ob.CurrentLocation));
                        MapControl.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.Behemoth], 778, 10, 1500,
                            ob.CurrentLocation, 0, true) { Blend = false });
                    }
                        break;
                    ...
                    case SpellEffect.KingGuard:
                        if(p.EffectType == 0) {
                            ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.KingGuard], 753, 10, 1000, ob)
                                { Blend = false });
                        } else {
                            ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.KingGuard], 763, 10, 1000, ob)
                                { Blend = false });
                        }
                    ...
                    case SpellEffect.DeathCrawlerBreath:
                        ob.Effects.Add(new Effect(Libraries.Monsters[(ushort)Monster.DeathCrawler],
                            272 + ((int)ob.Direction * 4), 4, 400, ob) { Blend = true });
                        break;
        ...
        private void Pushed(ServerPacket.Pushed p) {
            User.ActionFeed.Add(new QueuedAction
                { Action = MirAction.Pushed, Direction = p.Direction, Location = p.Location });
        }
        ...
        private void GroupInvite(ServerPacket.GroupInvite p) {
            MirMessageBox messageBox = new(string.Format("Do you want to group with {0}?", p.Name),
                MirMessageBoxButtons.YesNo);
            ...
            messageBox.NoButton.Click += (o, e) =>
                Network.Enqueue(new ClientPacket.GroupInvite { AcceptInvite = false });
            messageBox.Show();
        }
        ...
        private void ObjectRevived(ServerPacket.ObjectRevived p) {
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                ob.ActionFeed.Clear();
                ob.ActionFeed.Add(new QueuedAction
                    { Action = MirAction.Revive, Direction = ob.Direction, Location = ob.CurrentLocation });
                return;
            }
        }
        ...
        private void SpellToggle(ServerPacket.SpellToggle p) {
            ...
            switch (p.Spell) {
                ...
                case Spell.HalfMoon:
                    ...
                    ChatDialog.ReceiveChat(prefix + (actor.HalfMoon ? "Use HalfMoon." : "Do not use HalfMoon."),
                        ChatType.Hint);
                    break;
                case Spell.CrossHalfMoon:
                    actor.CrossHalfMoon = p.CanUse;
                    ChatDialog.ReceiveChat(
                        prefix + (actor.CrossHalfMoon ? "Use CrossHalfMoon." : "Do not use CrossHalfMoon."),
                        ChatType.Hint);
                    break;
                case Spell.DoubleSlash:
                    actor.DoubleSlash = p.CanUse;
                    ChatDialog.ReceiveChat(
                        prefix + (actor.DoubleSlash ? "Use DoubleSlash." : "Do not use DoubleSlash."), ChatType.Hint);
                    break;
                case Spell.FlamingSword:
        ...
        private void MapEffect(ServerPacket.MapEffect p) {
            switch (p.Effect) {
                case SpellEffect.Mine:
                    ...
                    Effect HitWall = new(Libraries.Effect, 8 * p.Value, 3, 240, p.Location) { Light = 0 };
                    MapControl.Effects.Add(HitWall);
                    break;
                case SpellEffect.Tester:
                    Effect eff = new(Libraries.Effect, 328, 10, 500, p.Location) { Light = 0 };
            ...
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                if(ob.Race == ObjectType.Player) {
                    switch (p.Type) {
                        default: {
                            action = new QueuedAction {
                                Action = MirAction.AttackRange1, Direction = p.Direction, Location = p.Location,
                                Params = new List<object>()
                            };
                            break;
                        }
                    ...
                    switch (p.Type) {
                        case 1: {
                            action = new QueuedAction {
                                Action = MirAction.AttackRange2, Direction = p.Direction, Location = p.Location,
                                Params = new List<object>()
                            };
                            break;
                        }
                        case 2: {
                            action = new QueuedAction {
                                Action = MirAction.AttackRange3, Direction = p.Direction, Location = p.Location,
                                Params = new List<object>()
                            };
                            break;
                        }
        ...
        private void AddBuff(ServerPacket.AddBuff p) {
            ...
            if(buff.ObjectID == User.ObjectID) {
                for (int i = 0; i < BuffsDialog.Buffs.Count; i++) {
                    if(BuffsDialog.Buffs[i].Type != buff.Type) {
                        continue;
                    }
            ...
            if(Hero != null && buff.ObjectID == Hero.ObjectID) {
                for (int i = 0; i < HeroBuffsDialog.Buffs.Count; i++) {
                    if(HeroBuffsDialog.Buffs[i].Type != buff.Type) {
                        continue;
                    }
        ...
        private void RemoveBuff(ServerPacket.RemoveBuff p) {
            if(User.ObjectID == p.ObjectID) {
                for (int i = 0; i < BuffsDialog.Buffs.Count; i++) {
                    if(BuffsDialog.Buffs[i].Type != p.Type) {
                        continue;
                    }
            ...
            if(Hero != null && Hero.ObjectID == p.ObjectID) {
                for (int i = 0; i < HeroBuffsDialog.Buffs.Count; i++) {
                    if(HeroBuffsDialog.Buffs[i].Type != p.Type) {
                        continue;
                    }
        ...
        private void PauseBuff(ServerPacket.PauseBuff p) {
            if(User.ObjectID == p.ObjectID) {
                for (int i = 0; i < BuffsDialog.Buffs.Count; i++) {
                    ...
                    if(BuffsDialog.Buffs[i].Paused == p.Paused) {
                        return;
                    }
            ...
            if(Hero != null && Hero.ObjectID == p.ObjectID) {
                for (int i = 0; i < HeroBuffsDialog.Buffs.Count; i++) {
                    ...
                    if(HeroBuffsDialog.Buffs[i].Paused == p.Paused) {
                        return;
                    }
        ...
        private void ObjectLevelEffects(ServerPacket.ObjectLevelEffects p) {
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                MapObject ob = MapControl.Objects[i];
                if(ob.ObjectID != p.ObjectID || ob.Race != ObjectType.Player) {
                    continue;
                }
        ...
        private void ObjectSpell(ServerPacket.ObjectSpell p) {
            SpellObject ob = new(p.ObjectID);
            ob.Load(p);
        }

        private void ObjectDeco(ServerPacket.ObjectDeco p) {
            DecoObject ob = new(p.ObjectID);
            ob.Load(p);
        }
        ...
        private void UserDashFail(ServerPacket.UserDashFail p) {
            MapControl.NextAction = 0;
            User.ActionFeed.Add(new QueuedAction
                { Action = MirAction.DashFail, Direction = p.Direction, Location = p.Location });
        }
        ...
        private void UserBackStep(ServerPacket.UserBackStep p) {
            ...
            User.ActionFeed.Add(new QueuedAction
                { Action = MirAction.Jump, Direction = p.Direction, Location = p.Location });
        }
        ...
        private void UserDashAttack(ServerPacket.UserDashAttack p) {
            ...
            User.ActionFeed.Add(new QueuedAction
                { Action = MirAction.DashAttack, Direction = p.Direction, Location = p.Location });
        }
        ...
        private void SetConcentration(ServerPacket.SetConcentration p) {
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                if(MapControl.Objects[i].Race != ObjectType.Player) {
                    continue;
                }
        ...
        private void SetElemental(ServerPacket.SetElemental p) {
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                if(p.Enabled && p.ElementType > 0) {
                    ob.Effects.Add(new ElementsEffect(Libraries.Magic3, 1630 + ((elementType - 1) * 10), 10, 10 * 100,
                        ob, true, 1 + (elementType - 1), maxExp,
        ...
        private void SetBindingShot(ServerPacket.SetBindingShot p) {
            ...
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                TrackableEffect NetCast = new(new Effect(Libraries.MagicC, 0, 8, 700, ob));
                ...
                TrackableEffect NetDropped = new(new Effect(Libraries.MagicC, 7, 1, 1000, ob)
                    { Repeat = true, RepeatUntil = CMain.Time + (p.Value - 1500) });
                NetDropped.EffectName = "BindingShotDown";

                TrackableEffect NetFall = new(new Effect(Libraries.MagicC, 8, 8, 700, ob));
        ...
        private void ObjectSitDown(ServerPacket.ObjectSitDown p) {
            ...
            for (int i = MapControl.Objects.Count - 1; i >= 0; i--) {
                ...
                ob.ActionFeed.Add(new QueuedAction
                    { Action = MirAction.SitDown, Direction = p.Direction, Location = p.Location });
                return;
            }
        }
        ...
        private void GuildInvite(ServerPacket.GuildInvite p) {
            MirMessageBox messageBox = new(string.Format("Do you want to join the {0} guild?", p.Name),
                MirMessageBoxButtons.YesNo);

            messageBox.YesButton.Click += (o, e) =>
                Network.Enqueue(new ClientPacket.GuildInvite { AcceptInvite = true });
            messageBox.NoButton.Click += (o, e) =>
                Network.Enqueue(new ClientPacket.GuildInvite { AcceptInvite = false });

            messageBox.Show();
        }

        private void GuildNameRequest(ServerPacket.GuildNameRequest p) {
            MirInputBox inputBox = new("Please enter a guild name, length must be 3~20 characters.");
        ...
        private void GuildRequestWar(ServerPacket.GuildRequestWar p) {
            MirInputBox inputBox = new("Please enter the guild you would like to go to war with.");
        ...
        private void GuildStorageGoldChange(ServerPacket.GuildStorageGoldChange p) {
            switch (p.Type) {
                case 0:
                    ChatDialog.ReceiveChat(String.Format("{0} donated {1} gold to guild funds.", p.Name, p.Amount),
                        ChatType.Guild);
                    GuildDialog.Gold += p.Amount;
                    break;
                case 1:
                    ChatDialog.ReceiveChat(String.Format("{0} retrieved {1} gold from guild funds.", p.Name, p.Amount),
                        ChatType.Guild);
        ...
        private void GuildStorageList(ServerPacket.GuildStorageList p) {
            for (int i = 0; i < p.Items.Length; i++) {
                if(i >= GuildDialog.StorageGrid.Length) {
                    break;
                }
        ...
        private void HeroInformation(ServerPacket.HeroInformation p) {
            ...
            HeroBuffsDialog = new BuffDialog {
                ...
                GetExpandedParameter = () => {
                    return Settings.ExpandedHeroBuffWindow;
                },
                SetExpandedParameter = (value) => {
                    Settings.ExpandedHeroBuffWindow = value;
                }
            };
            MainDialog.HeroInfoPanel.Update();
        ...
        private void MarriageRequest(ServerPacket.MarriageRequest p) {
            MirMessageBox messageBox = new(string.Format("{0} has asked for your hand in marriage.", p.Name),
                MirMessageBoxButtons.YesNo);

            messageBox.YesButton.Click += (o, e) =>
                Network.Enqueue(new ClientPacket.MarriageReply { AcceptInvite = true });
            messageBox.NoButton.Click += (o, e) => {
                Network.Enqueue(new ClientPacket.MarriageReply { AcceptInvite = false });
                messageBox.Dispose();
            };
        ...
        private void DivorceRequest(ServerPacket.DivorceRequest p) {
            MirMessageBox messageBox = new(string.Format("{0} has requested a divorce", p.Name),
                MirMessageBoxButtons.YesNo);

            messageBox.YesButton.Click += (o, e) =>
                Network.Enqueue(new ClientPacket.DivorceReply { AcceptInvite = true });
            messageBox.NoButton.Click += (o, e) => {
                Network.Enqueue(new ClientPacket.DivorceReply { AcceptInvite = false });
                messageBox.Dispose();
            };
        ...
        private void MentorRequest(ServerPacket.MentorRequest p) {
            MirMessageBox messageBox =
                new(
                    string.Format("{0} (Level {1}) has requested you teach him the ways of the {2}.", p.Name, p.Level,
                        User.Class.ToString()), MirMessageBoxButtons.YesNo);

            messageBox.YesButton.Click += (o, e) =>
                Network.Enqueue(new ClientPacket.MentorReply { AcceptInvite = true });
            messageBox.NoButton.Click += (o, e) => {
                Network.Enqueue(new ClientPacket.MentorReply { AcceptInvite = false });
                messageBox.Dispose();
            };
        ...
        private void GuildBuffList(ServerPacket.GuildBuffList p) {
            ...
            if(GuildDialog.EnabledBuffs.Any(e => e.Active)) {
                if(buff == null) {
                    buff = new ClientBuff {
                        Type = BuffType.Guild, ObjectID = User.ObjectID, Caster = "Guild", Infinite = true,
                        Values = new int[0]
                    };
        ...
        private void TradeRequest(ServerPacket.TradeRequest p) {
            MirMessageBox messageBox = new(string.Format("Player {0} has requested to trade with you.", p.Name),
                MirMessageBoxButtons.YesNo);

            messageBox.YesButton.Click += (o, e) =>
                Network.Enqueue(new ClientPacket.TradeReply { AcceptInvite = true });
            messageBox.NoButton.Click += (o, e) => {
                Network.Enqueue(new ClientPacket.TradeReply { AcceptInvite = false });
                messageBox.Dispose();
            };
        ...
        private void MailSendRequest(ServerPacket.MailSendRequest p) {
            MirInputBox inputBox = new("Please enter the name of the person you would like to mail.");
        ...
        private void ParcelCollected(ServerPacket.ParcelCollected p) {
            switch (p.Result) {
                case -1:
                    MirMessageBox messageBox = new(string.Format("No parcels to collect."), MirMessageBoxButtons.OK);
                    messageBox.Show();
                    break;
                case 0:
                    messageBox = new MirMessageBox(string.Format("All parcels have been collected."),
                        MirMessageBoxButtons.OK);
                    messageBox.Show();
                    break;
                case 1:
        ...
        private void RequestReincarnation() {
            if(CMain.Time > User.DeadTime && User.CurrentAction == MirAction.Dead) {
                MirMessageBox messageBox = new("Would you like to be revived?", MirMessageBoxButtons.YesNo);
        ...
        private void NewIntelligentCreature(ServerPacket.NewIntelligentCreature p) {
            ...
            MirInputBox inputBox = new("Please give your creature a name.");
            ...
            inputBox.OKButton.Click += (o1, e1) => {
                ...
                Network.Enqueue(new ClientPacket.UpdateIntelligentCreature
                    { Creature = User.IntelligentCreatures[User.IntelligentCreatures.Count - 1] });
                inputBox.Dispose();
            };
            inputBox.Show();
        }
        ...
        private void GameShopUpdate(ServerPacket.GameShopInfo p) {
            ...
            if(p.Item.Date > CMain.Now.AddDays(-7)) {
                GameShopDialog.New.Visible = true;
            }
        }
        ...
        public MirControl NameInfoLabel(UserItem item, bool inspect = false, bool hideDura = false) {
            ...
            MirLabel nameLabel = new() {
                ...
                Text = HoverItem.Info.Grade != ItemGrade.None
                    ? string.Format("{0}{1}{2}", HoverItem.Info.FriendlyName, "\n", GradeString)
                    : HoverItem.Info.FriendlyName
            };
            ...
            if(HoverItem.Info.Durability > 0 && !hideDura) {
                switch (HoverItem.Info.Type) {
                    ...
                    case ItemType.Pets:
                        ...
                        break;
                    default:
                        text += string.Format(" {0} {1}/{2}", GameLanguage.Durability,
                            Math.Floor(HoverItem.CurrentDura / 1000M),
        ...
        public MirControl AttackInfoLabel(UserItem item, bool Inspect = false, bool hideAdded = false) {
            ...
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.MaxDC]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                if(HoverItem.Info.Type != ItemType.Gem) {
                    text = string.Format(addValue > 0 ? GameLanguage.DC : GameLanguage.DC2, minValue,
                        maxValue + addValue, addValue);
                } else {
                    text = string.Format("Adds +{0} DC", minValue + maxValue + addValue);
                }

                MirLabel DCLabel = new() {
                    AutoSize = true,
            ...
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.MaxMC]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                if(HoverItem.Info.Type != ItemType.Gem) {
                    text = string.Format(addValue > 0 ? GameLanguage.MC : GameLanguage.MC2, minValue,
                        maxValue + addValue, addValue);
                } else {
                    text = string.Format("Adds +{0} MC", minValue + maxValue + addValue);
                }

                MirLabel MCLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.MaxSC]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                if(HoverItem.Info.Type != ItemType.Gem) {
                    text = string.Format(addValue > 0 ? GameLanguage.SC : GameLanguage.SC2, minValue,
                        maxValue + addValue, addValue);
                } else {
                    text = string.Format("Adds +{0} SC", minValue + maxValue + addValue);
                }

                MirLabel SCLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.Luck]
                : 0;
            ...
            if(minValue != 0 || addValue != 0) {
                ...
                if(realItem.Type == ItemType.Pets && realItem.Shape == 28) {
                    ...
                    text = string.Format(minValue + addValue > 0 ? GameLanguage.Luck : "Curse + {0}",
                        Math.Abs(minValue + addValue));
                }

                MirLabel LUCKLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.Accuracy]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                if(HoverItem.Info.Type != ItemType.Gem) {
                    text = string.Format(addValue > 0 ? GameLanguage.Accuracy : GameLanguage.Accuracy2,
                        minValue + addValue, addValue);
                } else {
                    text = string.Format("Adds +{0} Accuracy", minValue + maxValue + addValue);
                }

                MirLabel ACCLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                ...
                MirLabel HOLYLabel = new() {
                    ...
                    Text = string.Format(addValue > 0 ? GameLanguage.Holy : GameLanguage.Holy2, minValue + addValue,
                        addValue)
                };
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.AttackSpeed]
                : 0;
            ...
            if(minValue != 0 || maxValue != 0 || addValue != 0) {
                ...
                if(HoverItem.Info.Type != ItemType.Gem) {
                    ...
                    text = string.Format(
                        addValue != 0 ? "A.Speed: " + plus + "{0} ({2}{1})" : "A.Speed: " + plus + "{0}",
                        minValue + addValue, addValue, negative);
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.Freezing]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                if(HoverItem.Info.Type != ItemType.Gem) {
                    text = string.Format(addValue > 0 ? "Freezing: + {0} (+{1})" : "Freezing: + {0}",
                        minValue + addValue, addValue);
                } else {
                    text = string.Format("Adds +{0} Freezing", minValue + maxValue + addValue);
                }

                MirLabel FREEZINGLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.PoisonAttack]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                if(HoverItem.Info.Type != ItemType.Gem) {
                    text = string.Format(addValue > 0 ? "Poison: + {0} (+{1})" : "Poison: + {0}", minValue + addValue,
                        addValue);
                } else {
                    text = string.Format("Adds +{0} Poison", minValue + maxValue + addValue);
                }

                MirLabel POISONLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.CriticalRate]
                : 0;

            if((minValue > 0 || maxValue > 0 || addValue > 0) && realItem.Type != ItemType.Gem) {
                count++;
                MirLabel CRITICALRATELabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
                    ...
                    Text = string.Format(addValue > 0 ? "Critical Chance: + {0} (+{1})" : "Critical Chance: + {0}",
                        minValue + addValue, addValue)
                };

                if(fishingItem) {
                    CRITICALRATELabel.Text =
                        string.Format(addValue > 0 ? "Flexibility: + {0} (+{1})" : "Flexibility: + {0}",
                            minValue + addValue, addValue);
                }
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.CriticalDamage]
                : 0;

            if((minValue > 0 || maxValue > 0 || addValue > 0) && realItem.Type != ItemType.Gem) {
                count++;
                MirLabel CRITICALDAMAGELabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
                    ...
                    Text = string.Format(addValue > 0 ? "Critical Damage: + {0} (+{1})" : "Critical Damage: + {0}",
                        minValue + addValue, addValue)
                };
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.ExpRatePercent]
                : 0;
            ...
            if(minValue != 0 || maxValue != 0 || addValue != 0) {
                ...
                text = string.Format(
                    addValue != 0 ? "Exp Rate: " + plus + "{0}% ({2}{1}%)" : "Exp Rate: " + plus + "{0}%",
                    minValue + addValue, addValue, negative);

                MirLabel expRateLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.ItemDropRatePercent]
                : 0;
            ...
            if(minValue != 0 || maxValue != 0 || addValue != 0) {
                ...
                text = string.Format(
                    addValue != 0 ? "Drop Rate: " + plus + "{0}% ({2}{1}%)" : "Drop Rate: " + plus + "{0}%",
                    minValue + addValue, addValue, negative);

                MirLabel dropRateLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.GoldDropRatePercent]
                : 0;
            ...
            if(minValue != 0 || maxValue != 0 || addValue != 0) {
                ...
                text = string.Format(
                    addValue != 0 ? "Gold Rate: " + plus + "{0}% ({2}{1}%)" : "Gold Rate: " + plus + "{0}%",
                    minValue + addValue, addValue, negative);

                MirLabel goldRateLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            if(HoverItem.AddedStats[Stat.Hero] > 0) {
                ClientHeroInformation heroInfo =
                    HeroInfoList.FirstOrDefault(x => x.Index == HoverItem.AddedStats[Stat.Hero]);
                if(heroInfo != null) {
                    count++;
                    text = heroInfo.ToString();

                    MirLabel heroLabel = new() {
                        AutoSize = true,
                        ForeColour = Color.White,
                        Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                        OutLine = true,
        ...
        public MirControl DefenceInfoLabel(UserItem item, bool Inspect = false, bool hideAdded = false) {
            ...
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.MaxAC]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                if(HoverItem.Info.Type != ItemType.Gem) {
                    text = string.Format(addValue > 0 ? GameLanguage.AC : GameLanguage.AC2, minValue,
                        maxValue + addValue, addValue);
                } else {
                    text = string.Format("Adds +{0} AC", minValue + maxValue + addValue);
                }

                MirLabel ACLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
                ...
                if(fishingItem) {
                    if(HoverItem.Info.Type == ItemType.Float) {
                        ACLabel.Text =
                            string.Format("Nibble Chance + " + (addValue > 0 ? "{0}~{1}% (+{2})" : "{0}~{1}%"),
                                minValue, maxValue + addValue);
                    } else if(HoverItem.Info.Type == ItemType.Finder) {
                        ACLabel.Text =
                            string.Format("Finder Increase + " + (addValue > 0 ? "{0}~{1}% (+{2})" : "{0}~{1}%"),
                                minValue, maxValue + addValue);
                    } else {
                        ACLabel.Text = string.Format("Success Chance + " + (addValue > 0 ? "{0}% (+{1})" : "{0}%"),
            ...
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.MaxMAC]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                if(HoverItem.Info.Type != ItemType.Gem) {
                    text = string.Format(addValue > 0 ? GameLanguage.MAC : GameLanguage.MAC2, minValue,
                        maxValue + addValue, addValue);
                } else {
                    text = string.Format("Adds +{0} MAC", minValue + maxValue + addValue);
                }

                MirLabel MACLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            if(HoverItem.Info.Type != ItemType.MonsterSpawn) {
                ...
                maxValue = 0;
                addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                    ? HoverItem.AddedStats[Stat.HP]
                    : 0;

                if(minValue > 0 || maxValue > 0 || addValue > 0) {
                    count++;
                    MirLabel MAXHPLabel = new() {
                        AutoSize = true,
                        ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                        Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                        OutLine = true,
                        ...
                        Text = string.Format(addValue > 0 ? "Max HP + {0} (+{1})" : "Max HP + {0}", minValue + addValue,
                            addValue)
                    };
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.MP]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                MirLabel MAXMPLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
                    ...
                    Text = string.Format(addValue > 0 ? "Max MP + {0} (+{1})" : "Max MP + {0}", minValue + addValue,
                        addValue)
                };
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.HealthRecovery]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                MirLabel HEALTH_RECOVERYLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(addValue > 0 ? "Health Recovery + {0} (+{1})" : "Health Recovery + {0}",
                        minValue + addValue, addValue)
                };
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.SpellRecovery]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                MirLabel MANA_RECOVERYLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
                    ...
                    Text = string.Format(addValue > 0 ? "Mana Recovery + {0} (+{1})" : "Mana Recovery + {0}",
                        minValue + addValue, addValue)
                };
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.PoisonRecovery]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                MirLabel POISON_RECOVERYabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
                    ...
                    Text = string.Format(addValue > 0 ? "Poison Recovery + {0} (+{1})" : "Poison Recovery + {0}",
                        minValue + addValue, addValue)
                };

                ItemLabel.Size = new Size(
                    Math.Max(ItemLabel.Size.Width, POISON_RECOVERYabel.DisplayRectangle.Right + 4),
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.Agility]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                if(HoverItem.Info.Type != ItemType.Gem) {
                    text = string.Format(addValue > 0 ? GameLanguage.Agility : GameLanguage.Agility2,
                        minValue + addValue, addValue);
                } else {
                    text = string.Format("Adds +{0} Agility", minValue + maxValue + addValue);
                }

                MirLabel AGILITYLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.Strong]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                MirLabel STRONGLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
                    ...
                    Text = string.Format(addValue > 0 ? "Strong + {0} (+{1})" : "Strong + {0}", minValue + addValue,
                        addValue)
                };
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.PoisonResist]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                if(HoverItem.Info.Type != ItemType.Gem) {
                    text = string.Format(addValue > 0 ? "Poison Resist + {0} (+{1})" : "Poison Resist + {0}",
                        minValue + addValue, addValue);
                } else {
                    text = string.Format("Adds +{0} Poison Resist", minValue + maxValue + addValue);
                }

                MirLabel POISON_RESISTLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            maxValue = 0;
            addValue = !hideAdded && (!HoverItem.Info.NeedIdentify || HoverItem.Identified)
                ? HoverItem.AddedStats[Stat.MagicResist]
                : 0;

            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                count++;
                if(HoverItem.Info.Type != ItemType.Gem) {
                    text = string.Format(addValue > 0 ? "Magic Resist + {0} (+{1})" : "Magic Resist + {0}",
                        minValue + addValue, addValue);
                } else {
                    text = string.Format("Adds +{0} Magic Resist", minValue + maxValue + addValue);
                }

                MirLabel MAGIC_RESISTLabel = new() {
                    AutoSize = true,
                    ForeColour = addValue > 0 ? Color.Cyan : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
        ...
        public MirControl WeightInfoLabel(UserItem item, bool Inspect = false) {
            ...
            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                ...
                MirLabel HANDWEIGHTLabel = new() {
                    ...
                    Text = string.Format(addValue > 0 ? "Hand Weight + {0} (+{1})" : "Hand Weight + {0}",
                        minValue + addValue, addValue)
                };
            ...
            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                ...
                MirLabel WEARWEIGHTLabel = new() {
                    ...
                    Text = string.Format(addValue > 0 ? "Wear Weight + {0} (+{1})" : "Wear Weight + {0}",
                        minValue + addValue, addValue)
                };
            ...
            if(minValue > 0 || maxValue > 0 || addValue > 0) {
                ...
                MirLabel BAGWEIGHTLabel = new() {
                    ...
                    Text = string.Format(addValue > 0 ? "Bag Weight + {0} (+{1})" : "Bag Weight + {0}",
                        minValue + addValue, addValue)
                };
            ...
            if(HoverItem.Info.Type == ItemType.Potion && HoverItem.Info.Durability > 0) {
                ...
                MirLabel TNRLabel = new() {
                    ...
                    Text = string.Format("Time : {0}",
                        Functions.PrintTimeSpanFromSeconds(HoverItem.Info.Durability * 60))
                };
            ...
            if(HoverItem.Info.Type == ItemType.Transform && HoverItem.Info.Durability > 0) {
                ...
                MirLabel TNRLabel = new() {
                    ...
                    Parent = ItemLabel,
                    Text = string.Format("Time : {0}",
                        Functions.PrintTimeSpanFromSeconds(HoverItem.Info.Durability, false))
                };
        ...
        public MirControl AwakeInfoLabel(UserItem item, bool Inspect = false) {
            ...
            if(HoverItem.Awake.GetAwakeLevel() > 0) {
                count++;
                MirLabel AWAKENAMELabel = new() {
                    AutoSize = true,
                    ForeColour = GradeNameColor(HoverItem.Info.Grade),
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format("{0} Awakening({1})", HoverItem.Awake.Type.ToString(),
            ...
            if(HoverItem.Awake.GetAwakeValue() > 0) {
                count++;
                MirLabel AWAKE_TOTAL_VALUELabel = new() {
                    AutoSize = true,
                    ForeColour = Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(realItem.Type != ItemType.Armour ? "{0} + {1}~{2}" : "MAX {0} + {1}",
                        HoverItem.Awake.Type.ToString(), HoverItem.Awake.GetAwakeValue(),
                        HoverItem.Awake.GetAwakeValue())
                };

                ItemLabel.Size = new Size(
                    Math.Max(ItemLabel.Size.Width, AWAKE_TOTAL_VALUELabel.DisplayRectangle.Right + 4),
            ...
            if(HoverItem.Awake.GetAwakeLevel() > 0) {
                ...
                for (int i = 0; i < HoverItem.Awake.GetAwakeLevel(); i++) {
                    MirLabel AWAKE_LEVEL_VALUELabel = new() {
                        AutoSize = true,
                        ForeColour = Color.White,
                        Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = string.Format(
                            realItem.Type != ItemType.Armour
                                ? "Level {0} : {1} + {2}~{3}"
                                : "Level {0} : MAX {1} + {2}~{3}", i + 1, HoverItem.Awake.Type.ToString(),
                            HoverItem.Awake.GetAwakeLevelValue(i), HoverItem.Awake.GetAwakeLevelValue(i))
                    };

                    ItemLabel.Size = new Size(
                        Math.Max(ItemLabel.Size.Width, AWAKE_LEVEL_VALUELabel.DisplayRectangle.Right + 4),
        ...
        public MirControl SocketInfoLabel(UserItem item, bool Inspect = false) {
            ...
            for (int i = 0; i < item.Slots.Length; i++) {
                count++;
                MirLabel SOCKETLabel = new() {
                    AutoSize = true,
                    ForeColour = count > realItem.Slots && !realItem.IsFishingRod && realItem.Type != ItemType.Mount
                        ? Color.Cyan
                        : Color.White,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
        ...
        public MirControl BindInfoLabel(UserItem item, bool Inspect = false, bool hideAdded = false) {
            ...
            if(HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontDeathdrop)) {
                count++;
                MirLabel DONT_DEATH_DROPLabel = new() {
                    AutoSize = true,
                ...
                ItemLabel.Size = new Size(
                    Math.Max(ItemLabel.Size.Width, DONT_DEATH_DROPLabel.DisplayRectangle.Right + 4),
            ...
            if(HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontUpgrade)) {
                count++;
                MirLabel DONT_UPGRADELabel = new() {
                    AutoSize = true,
                    ForeColour = Color.Yellow,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
            ...
            if(HoverItem.ExpireInfo != null) {
                ...
                MirLabel EXPIRELabel = new() {
                    ...
                    Text = remainingSeconds > 0
                        ? string.Format("Expires in {0}", Functions.PrintTimeSpanFromSeconds(remainingSeconds))
                        : "Expired"
                };
            ...
            if(HoverItem.SealedInfo != null) {
                ...
                if(remainingSeconds > 0) {
                    ...
                    MirLabel SEALEDLabel = new() {
                        ...
                        Parent = ItemLabel,
                        Text = remainingSeconds > 0
                            ? string.Format("Sealed for {0}", Functions.PrintTimeSpanFromSeconds(remainingSeconds))
                            : ""
                    };
            ...
            if(HoverItem.RentalInformation?.RentalLocked == false) {
                ...
                MirLabel RENTALLabel = new() {
                    ...
                    Text = remainingTime > 0
                        ? string.Format("Rental expires in: {0}", Functions.PrintTimeSpanFromSeconds(remainingTime))
                        : "Rental expired"
                };
            ...
            } else if(HoverItem.RentalInformation?.RentalLocked == true &&
                      HoverItem.RentalInformation.ExpiryDate > CMain.Now) {
                count++;
                double remainingTime = (HoverItem.RentalInformation.ExpiryDate - CMain.Now).TotalSeconds;
                MirLabel RentalLockLabel = new MirLabel {
                    AutoSize = true,
                    ForeColour = Color.DarkKhaki,
                    Location = new Point(4, ItemLabel.DisplayRectangle.Bottom),
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = remainingTime > 0
                        ? string.Format("Rental lock expires in: {0}",
                            Functions.PrintTimeSpanFromSeconds(remainingTime))
                        : "Rental lock expired"
                };
        ...
        public void CreateItemLabel(UserItem item, bool inspect = false, bool hideDura = false,
                                    bool hideAdded = false) {
            ...
            if(item == HoverItem && ItemLabel != null && !ItemLabel.IsDisposed) {
                return;
            }
            ...
            ItemLabel = new MirControl {
                ...
                Border = true,
                BorderColour = HoverItem.CurrentDura == 0 && HoverItem.MaxDura != 0
                    ? Color.Red
                    : Color.FromArgb(255, 148, 146, 148),
            ...
            foreach(MirControl outline in outlines) {
                if(outline != null) {
        ...
        public void Rankings(ServerPacket.Rankings p) {
            ...
            List<RankCharacterInfo> listings = new();
        ...
        private void DepositRentalItem(ServerPacket.DepositRentalItem p) {
            MirItemCell fromCell = p.From < User.BeltIdx
                ? BeltDialog.Grid[p.From]
                : InventoryDialog.Grid[p.From - User.BeltIdx];
            MirItemCell toCell = ItemRentingDialog.ItemCell;
        ...
        private void RetrieveRentalItem(ServerPacket.RetrieveRentalItem p) {
            MirItemCell fromCell = ItemRentingDialog.ItemCell;
            MirItemCell toCell =
                p.To < User.BeltIdx ? BeltDialog.Grid[p.To] : InventoryDialog.Grid[p.To - User.BeltIdx];
    ...
    public sealed class MapControl : MirControl {
        ...
        public static List<MapObject> Objects = new();
        ...
        public static Point MapLocation => GameScene.User == null
            ? Point.Empty
            : new Point((MouseLocation.X / CellWidth) - OffSetX, (MouseLocation.Y / CellHeight) - OffSetY).Add(
                GameScene.User.CurrentLocation);

        public static Point ToMouseLocation(Point p) {
            return new Point((p.X - MapObject.User.Movement.X + OffSetX) * CellWidth,
                (p.Y - MapObject.User.Movement.Y + OffSetY) * CellHeight).Add(MapObject.User.OffSetMove);
        }
        ...
        public void Process() {
            ...
            if(MapObject.TargetObject != null && MapObject.TargetObject is MonsterObject &&
               MapObject.TargetObject.AI == 64) {
                MapObject.TargetObjectID = 0;
            }

            if(MapObject.MagicObject != null && MapObject.MagicObject is MonsterObject &&
        ...
        protected override void CreateTexture() {
            ...
            if(FloorValid) {
                DXManager.Draw(DXManager.FloorTexture, new Rectangle(0, 0, Settings.ScreenWidth, Settings.ScreenHeight),
        ...
        protected internal override void DrawControl() {
            ...
            DXManager.DrawOpaque(ControlTexture, new Rectangle(0, 0, Settings.ScreenWidth, Settings.ScreenHeight),
                Vector3.Zero, Color.White, Opacity);
        ...
        private void DrawFloor() {
            if(DXManager.FloorTexture == null || DXManager.FloorTexture.Disposed) {
                DXManager.FloorTexture = new Texture(DXManager.Device, Settings.ScreenWidth, Settings.ScreenHeight, 1,
            ...
            for (int y = User.Movement.Y - ViewRangeY; y <= User.Movement.Y + ViewRangeY + 5; y++) {
                ...
                for (int x = User.Movement.X - ViewRangeX; x <= User.Movement.X + ViewRangeX; x++) {
                    ...
                    if(M2CellInfo[x, y].DoorIndex > 0) {
                        ...
                        if(DoorInfo == null) {
                            DoorInfo = new Door() {
                                index = M2CellInfo[x, y].DoorIndex, DoorState = 0, ImageIndex = 0, LastTick = CMain.Time
                            };
                            Doors.Add(DoorInfo);
                        } else {
        ...
        private void DrawObjects() {
            ...
            for (int y = User.Movement.Y - ViewRangeY; y <= User.Movement.Y + ViewRangeY + 25; y++) {
                ...
                for (int x = User.Movement.X - ViewRangeX; x <= User.Movement.X + ViewRangeX; x++) {
                    ...
                    if(M2CellInfo[x, y].MiddleIndex >= 0 &&
                       M2CellInfo[x, y].MiddleIndex !=
                       -1) //M2P '> 199' changed to '>= 0' to include mir2 libraries. Fixes middle layer tile strips draw. Also changed in 'DrawFloor' above.
                    {
                        index = M2CellInfo[x, y].MiddleImage - 1;
                        if(index > 0) {
            ...
            if(Settings.HighlightTarget) {
                if(MapObject.MouseObject != null && !MapObject.MouseObject.Dead &&
                   MapObject.MouseObject != MapObject.TargetObject && MapObject.MouseObject.Blend) {
        ...
        private Color GetBlindLight(Color light) {
            ...
            light = Color.FromArgb(255, Math.Max(20, light.R - (count * 10)), Math.Max(20, light.G - (count * 10)),
                Math.Max(20, light.B - (count * 10)));

            return light;
        }

        private void DrawLights(LightSetting setting) {
            if(DXManager.Lights == null || DXManager.Lights.Count == 0) {
                return;
            }

            if(DXManager.LightTexture == null || DXManager.LightTexture.Disposed) {
                DXManager.LightTexture = new Texture(DXManager.Device, Settings.ScreenWidth, Settings.ScreenHeight, 1,
                    Usage.RenderTarget, Format.A8R8G8B8, Pool.Default);
            ...
            for (int i = 0; i < Objects.Count; i++) {
                ...
                if(ob.Light > 0 && (!ob.Dead || ob == MapObject.User || ob.Race == ObjectType.Spell)) {
                    ...
                    if(DXManager.Lights[lightRange] != null && !DXManager.Lights[lightRange].Disposed) {
                        p.Offset(-(DXManager.LightSizes[lightRange].X / 2) - (CellWidth / 2),
                            -(DXManager.LightSizes[lightRange].Y / 2) - (CellHeight / 2) - 5);
                        DXManager.Draw(DXManager.Lights[lightRange], null, new Vector3((float)p.X, (float)p.Y, 0.0F),
                            lightColour);
                    }
                }
                ...
                for (int e = 0; e < ob.Effects.Count; e++) {
                    ...
                    if(!effect.Blend || CMain.Time < effect.Start ||
                       (!(effect is Missile) && effect.Light < ob.Light)) {
                        continue;
                    }
                    ...
                    if(DXManager.Lights[light] != null && !DXManager.Lights[light].Disposed) {
                        p.Offset(-(DXManager.LightSizes[light].X / 2) - (CellWidth / 2),
                            -(DXManager.LightSizes[light].Y / 2) - (CellHeight / 2) - 5);
                        DXManager.Draw(DXManager.Lights[light], null, new Vector3((float)p.X, (float)p.Y, 0.0F),
                            lightColour);
                    }
                }
            ...
            for (int y = MapObject.User.Movement.Y - ViewRangeY - 24;
                 y <= MapObject.User.Movement.Y + ViewRangeY + 24;
                 y++) {
                if(y < 0) {
                    continue;
                }
                ...
                for (int x = MapObject.User.Movement.X - ViewRangeX - 24;
                     x < MapObject.User.Movement.X + ViewRangeX + 24;
                     x++) {
                    if(x < 0) {
                        continue;
                    }
                    ...
                    if(DXManager.Lights[light] != null && !DXManager.Lights[light].Disposed) {
                        p.Offset(-(DXManager.LightSizes[light].X / 2) - (CellWidth / 2) + 10,
                            -(DXManager.LightSizes[light].Y / 2) - (CellHeight / 2) - 5);
                        DXManager.Draw(DXManager.Lights[light], null, new Vector3((float)p.X, (float)p.Y, 0.0F),
                            lightIntensity);
                    }
            ...
            DXManager.Draw(DXManager.LightTexture, new Rectangle(0, 0, Settings.ScreenWidth, Settings.ScreenHeight),
                Vector3.Zero, Color.White);
        ...
        private static void OnMouseClick(object sender, EventArgs e) {
            ...
            switch (me.Button) {
                ...
                case MouseButtons.Right: {
                    AutoRun = false;
                    if(MapObject.MouseObject == null) {
                        if(Settings.NewMove && MapLocation != MapObject.User.CurrentLocation &&
                           GameScene.Scene.MapControl.EmptyCell(MapLocation)) {
                            List<Node> path =
                                GameScene.Scene.MapControl.PathFinder.FindPath(MapObject.User.CurrentLocation,
                                    MapLocation, 20);

                            if(path != null && path.Count > 0) {
                                GameScene.Scene.MapControl.CurrentPath = path;
                                GameScene.Scene.MapControl.AutoPath = true;
                                Point offset = MouseLocation.Subtract(ToMouseLocation(MapLocation));
                                Effects.Add(new Effect(Libraries.Magic3, 500, 10, 600, MapLocation)
                                    { DrawOffset = offset.Subtract(8, 15) });
                            }
                        }
        ...
        private static void OnMouseDown(object sender, MouseEventArgs e) {
            ...
            if(GameScene.SelectedCell != null) {
                ...
                if(cell.Item.Info.Bind.HasFlag(BindMode.DontDrop)) {
                    MirMessageBox messageBox = new(string.Format("You cannot drop {0}", cell.Item.FriendlyName),
                        MirMessageBoxButtons.OK);
                    messageBox.Show();
                    GameScene.SelectedCell = null;
                    return;
                ...
                if(cell.Item.Count == 1) {
                    MirMessageBox messageBox = new(string.Format(GameLanguage.DropTip, cell.Item.FriendlyName),
                        MirMessageBoxButtons.YesNo);
                    ...
                    MirAmountBox amountBox = new(GameLanguage.DropAmount, cell.Item.Info.Image, cell.Item.Count);
            ...
            if(GameScene.PickedUpGold) {
                MirAmountBox amountBox = new(GameLanguage.DropAmount, 116, GameScene.Gold);
            ...
            if(MapObject.MouseObject != null && !MapObject.MouseObject.Dead && !(MapObject.MouseObject is ItemObject) &&
               ...
               !(MapObject.MouseObject is MonsterObject && MapObject.MouseObject.AI == 64)
        ...
        private void CheckInput() {
            ...
            if(CMain.Time < InputDelay || User.Poison.HasFlag(PoisonType.Paralysis) ||
               User.Poison.HasFlag(PoisonType.LRParalysis) || User.Poison.HasFlag(PoisonType.Frozen) || User.Fishing) {
                return;
            }
                ...
                if(((MapObject.TargetObject.Name.EndsWith(")") || MapObject.TargetObject is PlayerObject) &&
                   ...
                   (!MapObject.TargetObject.Name.EndsWith(")") && MapObject.TargetObject is MonsterObject)) {
                    ...
                    if(User.Class == MirClass.Archer && User.HasClassWeapon && !User.RidingMount &&
                       !User.Fishing) //ArcherTest - non aggressive targets (player / pets)
                    {
                        if(Functions.InRange(MapObject.TargetObject.CurrentLocation, User.CurrentLocation,
                               Globals.MaxAttackRange)) {
                            if(CMain.Time > GameScene.AttackTime) {
                                User.QueuedAction = new QueuedAction {
                                    Action = MirAction.AttackRange1,
                                    Direction = Functions.DirectionFromPoint(User.CurrentLocation,
                                        MapObject.TargetObject.CurrentLocation),
                                    Location = User.CurrentLocation, Params = new List<object>()
                                };
                                User.QueuedAction.Params.Add(MapObject.TargetObject != null
                                    ? MapObject.TargetObject.ObjectID
                                    : (uint)0);
            ...
            if(AutoHit && !User.RidingMount) {
                if(CMain.Time > GameScene.AttackTime) {
                    User.QueuedAction = new QueuedAction
                        { Action = MirAction.Mine, Direction = User.Direction, Location = User.CurrentLocation };
                    return;
                }
            }
            ...
            if(MouseControl == this) {
                ...
                if(AutoRun) {
                    if(GameScene.CanRun && CanRun(direction) && CMain.Time > GameScene.NextRunTime && User.HP >= 10 &&
                       (!User.Sneaking || (User.Sneaking && User.Sprint))) //slow remove
                    {
                        ...
                        if(!fail) {
                            User.QueuedAction = new QueuedAction {
                                Action = MirAction.Running, Direction = direction,
                    ...
                    if(CanWalk(direction, out direction) &&
                       CheckDoorOpen(Functions.PointMove(User.CurrentLocation, direction, 1))) {
                        User.QueuedAction = new QueuedAction {
                            Action = MirAction.Walking, Direction = direction,
                    ...
                    if(direction != User.Direction) {
                        User.QueuedAction = new QueuedAction
                            { Action = MirAction.Standing, Direction = direction, Location = User.CurrentLocation };
                        return;
                    }
                ...
                switch (MapButtons) {
                    case MouseButtons.Left:
                        if(MapObject.MouseObject is NpcObject ||
                           (MapObject.MouseObject is PlayerObject && MapObject.MouseObject != User)) {
                            break;
                        }
                        ...
                        if(CMain.Alt && !User.RidingMount) {
                            User.QueuedAction = new QueuedAction
                                { Action = MirAction.Harvest, Direction = direction, Location = User.CurrentLocation };
                            return;
                        }
                        ...
                        if(CMain.Shift) {
                            if(CMain.Time > GameScene.AttackTime && CanRideAttack()) //ArcherTest - shift click
                            {
                                ...
                                if(User.Class == MirClass.Archer && User.HasClassWeapon && !User.RidingMount &&
                                   !User.Poison.HasFlag(PoisonType.Dazed)) {
                                    if(target != null) {
                                        if(!Functions.InRange(MapObject.MouseObject.CurrentLocation,
                                               User.CurrentLocation, Globals.MaxAttackRange)) {
                                            if(CMain.Time >= OutputDelay) {
                                                OutputDelay = CMain.Time + 1000;
                                                GameScene.Scene.OutputMessage("Target is too far.");
                                            }
                                    ...
                                    User.QueuedAction = new QueuedAction {
                                        Action = MirAction.AttackRange1, Direction = MouseDirection(),
                                        Location = User.CurrentLocation, Params = new List<object>()
                                    };
                                    User.QueuedAction.Params.Add(target != null ? target.ObjectID : (uint)0);
                                    User.QueuedAction.Params.Add(Functions.PointMove(User.CurrentLocation,
                                        MouseDirection(), 9));
                                    return;
                                }

                                //stops double slash from being used without empty hand or assassin weapon (otherwise bugs on second swing)
                                if(GameScene.User.DoubleSlash && !User.HasClassWeapon && User.Weapon > -1) {
                                    return;
                                }

                                if(User.Poison.HasFlag(PoisonType.Dazed)) {
                                    return;
                                }

                                User.QueuedAction = new QueuedAction {
                                    Action = MirAction.Attack1, Direction = direction, Location = User.CurrentLocation
                                };
                            }
                        ...
                        if(MapObject.MouseObject is MonsterObject && User.Class == MirClass.Archer &&
                           MapObject.TargetObject != null && !MapObject.TargetObject.Dead && User.HasClassWeapon &&
                           !User.RidingMount) //ArcherTest - range attack
                        {
                            if(Functions.InRange(MapObject.MouseObject.CurrentLocation, User.CurrentLocation,
                                   Globals.MaxAttackRange)) {
                                if(CMain.Time > GameScene.AttackTime) {
                                    User.QueuedAction = new QueuedAction {
                                        Action = MirAction.AttackRange1, Direction = direction,
                                        Location = User.CurrentLocation, Params = new List<object>()
                                    };
                        ...
                        if(!ValidPoint(Functions.PointMove(User.CurrentLocation, direction, 1))) {
                            if(MapObject.User.Equipment[(int)EquipmentSlot.Weapon] != null &&
                               MapObject.User.Equipment[(int)EquipmentSlot.Weapon].Info.CanMine) {
                                if(direction != User.Direction) {
                                    User.QueuedAction = new QueuedAction {
                                        Action = MirAction.Standing, Direction = direction,
                                        Location = User.CurrentLocation
                                    };
                                    return;
                                }
                    ...
                    case MouseButtons.Right:
                        ...
                        if(GameScene.CanRun && CanRun(direction) && CMain.Time > GameScene.NextRunTime &&
                           User.HP >= 10 && (!User.Sneaking || (User.Sneaking && User.Sprint))) //slow removed
                        {
                            int distance = User.RidingMount || (User.Sprint && !User.Sneaking) ? 3 : 2;
                            bool fail = false;
                            ...
                            if(!fail) {
                                User.QueuedAction = new QueuedAction {
                                    Action = MirAction.Running, Direction = direction,
                                    Location = Functions.PointMove(User.CurrentLocation, direction,
                                        User.RidingMount || (User.Sprint && !User.Sneaking) ? 3 : 2)
                                };
                                return;
                            }
                        }
            ...
            if(AutoPath) {
                ...
                List<Node> path = GameScene.Scene.MapControl.PathFinder.FindPath(MapObject.User.CurrentLocation,
                ...
                if(CurrentPath.Count > 0) {
                    ...
                    if(GameScene.CanRun && CanRun(dir) && CMain.Time > GameScene.NextRunTime && User.HP >= 10 &&
                       CurrentPath.Count > (User.RidingMount ? 2 : 1)) {
                        User.QueuedAction = new QueuedAction {
                            Action = MirAction.Running, Direction = dir,
                            Location = Functions.PointMove(User.CurrentLocation, dir, User.RidingMount ? 3 : 2)
                        };
                        return;
                    }
                    ...
                    if(CanWalk(dir)) {
                        User.QueuedAction = new QueuedAction {
                            Action = MirAction.Walking, Direction = dir,
            ...
            if(User.Class == MirClass.Archer && User.HasClassWeapon &&
               (MapObject.TargetObject is MonsterObject || MapObject.TargetObject is PlayerObject)) {
        ...
        public void UseMagic(ClientMagic magic, UserObject actor) {
            ...
            if(CMain.Time <= magic.CastTime + magic.Delay) {
                if(CMain.Time >= OutputDelay) {
                    OutputDelay = CMain.Time + 1000;
                    GameScene.Scene.OutputMessage(string.Format("You cannot cast {0} for another {1} seconds.",
                        magic.Spell.ToString(), ((magic.CastTime + magic.Delay - CMain.Time - 1) / 1000) + 1));
                }
            ...
            switch (magic.Spell) {
                ...
                case Spell.MeteorShower:
                    if(actor.NextMagicObject != null) {
                        if(!actor.NextMagicObject.Dead && actor.NextMagicObject.Race != ObjectType.Item &&
                           actor.NextMagicObject.Race != ObjectType.Merchant) {
                    ...
                    if(target != null && target.Race == ObjectType.Monster) {
                ...
                case Spell.Stonetrap:
                    ...
                    if(User.NextMagicObject != null) {
                        if(!User.NextMagicObject.Dead && User.NextMagicObject.Race != ObjectType.Item &&
                           User.NextMagicObject.Race != ObjectType.Merchant) {
                ...
                case Spell.Trap:
                    if(actor.NextMagicObject != null) {
                        if(!actor.NextMagicObject.Dead && User.NextMagicObject.Race != ObjectType.Item &&
                           actor.NextMagicObject.Race != ObjectType.Merchant) {
                            target = actor.NextMagicObject;
                        }
                    }
            ...
            MirDirection dir = target == null || target == User
                ? actor.NextMagicDirection
                : Functions.DirectionFromPoint(actor.CurrentLocation, target.CurrentLocation);
            ...
            if(actor == User) {
                User.QueuedAction = new QueuedAction {
                    Action = MirAction.Spell, Direction = dir, Location = User.CurrentLocation,
                    Params = new List<object>()
                };
                ...
                Network.Enqueue(new ClientPacket.Magic {
                    ObjectID = actor.ObjectID, Spell = magic.Spell, Direction = dir, TargetID = targetID,
                    Location = location, SpellTargetLock = CMain.SpellTargetLock
                });
            }
        }
        ...
        {
            Point p = new(MouseLocation.X / CellWidth, MouseLocation.Y / CellHeight);
            if(Functions.InRange(new Point(OffSetX, OffSetY), p, 2)) {
                return Functions.DirectionFromPoint(new Point(OffSetX, OffSetY), p);
            }

            PointF c = new((OffSetX * CellWidth) + (CellWidth / 2F), (OffSetY * CellHeight) + (CellHeight / 2F));
            PointF a = new(c.X, 0);
        ...
        public static int Direction16(Point source, Point destination) {
            PointF c = new(source.X, source.Y);
            PointF a = new(c.X, 0);
            PointF b = new(destination.X, destination.Y);
            float bc = (float)Distance(c, b);
            float ac = bc;
            b.Y -= c.Y;
            c.Y += bc;
        ...
        public bool EmptyCell(Point p) {
            if((M2CellInfo[p.X, p.Y].BackImage & 0x20000000) != 0 ||
               (M2CellInfo[p.X, p.Y].FrontImage & 0x8000) != 0) // + (M2CellInfo[P.X, P.Y].FrontImage & 0x7FFF) != 0)
            {
                return false;
            }
        ...
        private bool CanRun(MirDirection dir) {
            ...
            if(User.CurrentBagWeight > User.Stats[Stat.BagWeight]) {
                return false;
            }

            if(User.CurrentWearWeight > User.Stats[Stat.BagWeight]) {
                return false;
            }
        ...
        private bool CanRideAttack() {
            if(GameScene.User.RidingMount) {
                ...
                if(item == null || item.Slots.Length < 4 || item.Slots[(int)MountSlot.Bells] == null) {
                    return false;
                }
            }
        ...
        public bool CanFish(MirDirection dir) {
            if(!GameScene.User.HasFishingRod || GameScene.User.FishingTime + 1000 > CMain.Time) {
                return false;
            }
            ...
            if(GameScene.User.Direction != dir) {
                return false;
            }

            if(GameScene.User.TransformType >= 6 && GameScene.User.TransformType <= 9) {
                return false;
            }
        ...
        public bool CanFly(Point target) {
            ...
            while (location != target) {
                ...
                if(location.X < 0 || location.Y < 0 || location.X >= GameScene.Scene.MapControl.Width ||
                   location.Y >= GameScene.Scene.MapControl.Height) {
                    return false;
                }
        ...
        public void UpdateWeather() {
            ...
            List<ParticleImageInfo> textures = new();
            foreach(WeatherSetting itemWeather in Enum.GetValues(typeof(WeatherSetting)).Cast<object>().ToArray()) {
                ...
                switch (itemWeather) {
                    case WeatherSetting.Leaves:
                        ...
                        ParticleEngine LeavesEngine2 = new(textures, new Vector2(2f, 0), ParticleType.Leaves);
                        Vector2 lVelocity = new(0F, 0F);
                    ...
                    case WeatherSetting.FireyLeaves:
                        ...
                        ParticleEngine FLeavesEngine2 = new(textures, new Vector2(2f, 0), ParticleType.FireyLeaves);
                        Vector2 FlVelocity = new(0F, 0F);
                        for (int y = 512 * -1; y < Settings.ScreenHeight + 512; y += 512)
                        for (int x = 512 * -1; x < Settings.ScreenWidth + 512; x += 512) {
                    ...
                    case WeatherSetting.Rain:
                        ...
                        ParticleEngine RainEngine2 = new(textures, new Vector2(2f, 0), ParticleType.Rain);
                        Vector2 rsevelocity = new(0F, 0F);
                        int xVar = 512;
                        int yVar = 512;
                    ...
                    case WeatherSetting.Snow:
                        ...
                        ParticleEngine RainEngine = new(textures, new Vector2(0, 0), ParticleType.Snow);
                        Vector2 rsvelocity = new(1F, -1F);
                    ...
                    case WeatherSetting.Fog:
                        List<ParticleImageInfo> ftextures = new();
                        ftextures.Add(new ParticleImageInfo(Libraries.Weather, 0));
                        ParticleEngine fengine = new(ftextures, new Vector2(0, 0), ParticleType.Fog);
                        fengine.UpdateDelay = TimeSpan.FromMilliseconds(20);

                        Vector2 fvelocity = new(2F, -2F);
                    ...
                    case WeatherSetting.RedEmber:
                        List<ParticleImageInfo> rtextures = new List<ParticleImageInfo>();
                        rtextures.Add(new ParticleImageInfo(Libraries.Weather, 1, 9, 150));

                        ParticleEngine rengine =
                            new ParticleEngine(rtextures, new Vector2(0, 0), ParticleType.RedFogEmber);
                    ...
                    case WeatherSetting.WhiteEmber:
                        ...
                        ParticleEngine whiteEmberEngine =
                            new ParticleEngine(textures, new Vector2(0, 0), ParticleType.WhiteEmber);
                    ...
                    case WeatherSetting.PurpleLeaves:
                        ...
                        ParticleEngine pEmberEngine =
                            new ParticleEngine(textures, new Vector2(0, 0), ParticleType.PurpleLeaves);
                    ...
                    case WeatherSetting.YellowEmber:
                        ...
                        ParticleEngine yellowEmberEngine =
                            new ParticleEngine(textures, new Vector2(0, 0), ParticleType.YellowEmber);
                    ...
                    case WeatherSetting.FireParticle:
                        ...
                        ParticleEngine fEmberEngine =
                            new ParticleEngine(textures, new Vector2(0, 0), ParticleType.Bird);
                ...
                if(Doors[i].DoorState == DoorState.Opening || Doors[i].DoorState == DoorState.Closing) {
                    if(Doors[i].LastTick + 50 < CMain.Time) {
                        ...
                        if(Doors[i].ImageIndex == 1) //change the 1 if you want to animate doors opening/closing
                        {
                            ...
                            Doors[i].DoorState =
                                (DoorState)Enum.ToObject(typeof(DoorState), (byte)++Doors[i].DoorState % 4);
                        }
        ...
        public void OpenDoor(byte Index, bool closed) {
            ...
            Info.DoorState = closed ? DoorState.Closing :
                Info.DoorState == DoorState.Open ? DoorState.Open : DoorState.Opening;
            Info.ImageIndex = 0;
