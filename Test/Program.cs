...
//var npcFiles = Directory.GetFiles(@"C:\Users\Tang\Documents\Mir2\Crystal_ZhCN\Build\Server\Debug\Envir\NPCs", "*.txt", SearchOption.AllDirectories);
...
//    Console.Write($"npc脚本文件进度：{++complateCount}/{npcFiles.Length}");
//}
