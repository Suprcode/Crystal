...
namespace MirToolsCore.Libraries.Type
{
    public class WeMade
    {
        ...
        public WeMade(string name, bool InitializeImages = true)
        {
        ...
        public void ToMLibrary()
        {
            ...
            Crystal_2 library = new Crystal_2(fileName) { Images = new List<Crystal_2.MImage>(), IndexList = new List<int>(), Count = Images.Length };
            //library.Save();
            ...
            try
            {
                Parallel.For(0, Images.Length, options, i =>
                {
                    ...
                    if (image.HasMask)
                        library.Images[i] = new Crystal_2.MImage(image.Image, image.MaskImage) { X = image.X, Y = image.Y, ShadowX = image.ShadowX, ShadowY = image.ShadowY, Shadow = image.boHasShadow ? (byte)1 : (byte)0, MaskX = image.X, MaskY = image.Y };
                    else
                        library.Images[i] = new Crystal_2.MImage(image.Image) { X = image.X, Y = image.Y, ShadowX = image.ShadowX, ShadowY = image.ShadowY, Shadow = image.boHasShadow ? (byte)1 : (byte)0 };
                });
            }
        ...
        public void ToImageArray()
        {
            ...
            Crystal_2 library = new Crystal_2(null) { Images = new List<Crystal_2.MImage>(), IndexList = new List<int>(), Count = Images.Length };
            //library.Save();
            ...
            try
            {
                Parallel.For(0, Images.Length, options, i =>
                {
                    WeMadeImage image = Images[i];
                    if (image.HasMask)
                        library.Images[0] = new Crystal_2.MImage(image.Image, image.MaskImage) { X = image.X, Y = image.Y, ShadowX = image.ShadowX, ShadowY = image.ShadowY, Shadow = image.boHasShadow ? (byte)1 : (byte)0, MaskX = image.X, MaskY = image.Y };
                    else
                        library.Images[0] = new Crystal_2.MImage(image.Image) { X = image.X, Y = image.Y, ShadowX = image.ShadowX, ShadowY = image.ShadowY, Shadow = image.boHasShadow ? (byte)1 : (byte)0 };
