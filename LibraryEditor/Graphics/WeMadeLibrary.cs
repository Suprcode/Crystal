...
namespace LibraryEditor.Graphics {
    public class WeMadeLibrary {
        ...
        public byte
            _nType = 0; //0 = .wil //1 = .wzl //2 = .wil new wemade design //3 = .wil mir3 //4 = .miz shanda mir3 // 5 = 32bit wil
        ...
        public void Initialize() {
            ...
            if(!File.Exists(_fileName + _IndexExtention)) {
                return;
            }

            if(!File.Exists(_fileName + _MainExtention)) {
                return;
            }
        ...
        private void LoadImageInfo() {
            ...
            _palette = new int[256] {
                -16777216, -8388608, -16744448, -8355840, -16777088, -8388480, -16744320, -4144960, -11173737, -6440504,
                -8686733, -13817559, -10857902, -10266022, -12437191, -14870504, -15200240, -14084072, -15726584,
                -886415, -2005153, -42406, -52943, -2729390, -7073792, -7067368, -13039616, -9236480, -4909056,
                -4365486, -12445680, -21863, -10874880, -9225943, -5944783, -7046285, -4369871, -11394800, -8703720,
                -13821936, -7583183, -7067392, -4378368, -3771566, -9752296, -3773630, -3257856, -5938375, -10866408,
                -14020608, -15398912, -12969984, -16252928, -14090240, -11927552, -6488064, -2359296, -2228224, -327680,
                -6524078, -7050422, -9221591, -11390696, -7583208, -7846895, -11919104, -14608368, -2714534, -3773663,
                -1086720, -35072, -5925756, -12439263, -15200248, -14084088, -14610432, -13031144, -7576775, -12441328,
                -9747944, -8697320, -7058944, -7568261, -9739430, -11910599, -14081768, -12175063, -4872812, -8688806,
                -3231340, -5927821, -7572646, -4877197, -2710157, -1071798, -1063284, -8690878, -9742791, -4352934,
                -10274560, -2701651, -11386327, -7052520, -1059155, -5927837, -10266038, -4348549, -10862056, -4355023,
                -13291223, -7043997, -8688822, -5927846, -10859991, -6522055, -12439280, -1069791, -15200256, -14081792,
                -6526208, -7044006, -11386344, -9741783, -8690911, -6522079, -2185984, -10857927, -13555440, -3228293,
                -10266055, -7044022, -3758807, -15688680, -12415926, -13530046, -15690711, -16246768, -16246760,
                -16242416, -15187415, -5917267, -9735309, -15193815, -15187382, -13548982, -10238242, -12263937,
                -7547153, -9213127, -532935, -528500, -530688, -9737382, -10842971, -12995089, -11887410, -13531979,
                -13544853, -2171178, -4342347, -7566204, -526370, -16775144, -16246727, -16248791, -16246784, -16242432,
                -16756059, -16745506, -15718070, -15713941, -15707508, -14591323, -15716006, -15711612, -13544828,
                -15195855, -11904389, -11375707, -14075549, -15709474, -14079711, -11908551, -14079720, -11908567,
                -8684734, -6513590, -10855895, -12434924, -13027072, -10921728, -3525332, -9735391, -14077696,
                -13551344, -13551336, -12432896, -11377896, -10849495, -13546984, -15195904, -15191808, -15189744,
                -10255286, -9716406, -10242742, -10240694, -10838966, -11891655, -10238390, -10234294, -11369398,
                -13536471, -10238374, -11354806, -15663360, -15193832, -11892662, -11868342, -16754176, -16742400,
                -16739328, -16720384, -16716288, -16712960, -11904364, -10259531, -8680234, -9733162, -8943361,
                -3750194, -7039844, -6515514, -13553351, -14083964, -15204220, -11910574, -11386245, -10265997,
                -3230217, -7570532, -8969524, -2249985, -1002454, -2162529, -1894477, -1040, -6250332, -8355712, -65536,
                -16711936, -256, -16776961, -65281, -16711681, -1
            };
        ...
        private void CheckImage(int index) {
            ...
            if(Images[index].Image == null) {
                _fStream.Seek(_indexList[index] + (_nType > 0 ? ImageStructureSize[_nType] : _version == 0 ? 8 : 12),
                    SeekOrigin.Begin);
        ...
        public void ToMLibrary() {
            ...
            MLibraryV2 library = new(fileName)
                ...
                Parallel.For(0, Images.Length, options, i => {
                    ...
                    if(image.HasMask) {
                        library.Images[i] = new MLibraryV2.MImage(image.Image, image.MaskImage) {
                            X = image.X, Y = image.Y, ShadowX = image.ShadowX, ShadowY = image.ShadowY,
                            Shadow = image.boHasShadow ? (byte)1 : (byte)0, MaskX = image.X, MaskY = image.Y
                        };
                    } else {
                        library.Images[i] = new MLibraryV2.MImage(image.Image) {
                            X = image.X, Y = image.Y, ShadowX = image.ShadowX, ShadowY = image.ShadowY,
                            Shadow = image.boHasShadow ? (byte)1 : (byte)0
                        };
                    }
                });
            } catch(Exception) {
        ...
        public class WeMadeImage {
            ...
            private int convert16bitTo32bit(int color) {
                ...
                return
                    (red << 0x10) | (green << 0x8) | blue |
                    (255 << 24); //the final or is setting alpha to max so it'll display (since mir2 images have no alpha layer)
            }
            ...
            private byte[][] DecompressWemadeMir3(BinaryReader BReader, short OutputWidth, short OutputHeight,
                                                  int InputLength) {
            ...
            public unsafe void CreateTexture(BinaryReader reader, int[] palette) {
                ...
                BitmapData data = Image.LockBits(new Rectangle(0, 0, Width, Height), ImageLockMode.WriteOnly,
                ...
                switch (nType) {
                    ...
                    case 4: //shanda miz file compressed
                        ...
                        ZlibStream deflateStream = new(output, CompressionMode.Decompress);
                    ...
                    case 5:
                        ...
                        MemoryStream input = new(reader.ReadBytes(nSize - 6));
                        output = new MemoryStream();
                        byte[] buffer = new byte[10];
                        DeflateStream decompress = new(input, System.IO.Compression.CompressionMode.Decompress);
                        int len;
                ...
                index = 0;
                if(HasMask) {
                    BitmapData Maskdata = MaskImage.LockBits(new Rectangle(0, 0, Width, Height),
                    ...
                    int* maskscan0 = (int*)Maskdata.Scan0;
                    {
                        for (int y = Height - 1; y >= 0; y--) {
                            for (int x = 0; x < Width; x++) {
                                maskscan0[(y * Width) + x] =
                                    convert16bitTo32bit(maskbytes[index++] + (maskbytes[index++] << 8));
                            }
                        }
                    }
