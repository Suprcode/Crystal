...
namespace LibraryEditor
{
    public class FrameSet : Dictionary<MirAction, Frame>
    {
        ...
        public static FrameSet DefaultMonsterFrameSet = new FrameSet
        {
            ...
            { MirAction.Attack2, new Frame(800, 6, 0, 100) },
            { MirAction.Attack3, new Frame(800, 6, 0, 100) },
            { MirAction.AttackRange1, new Frame(800, 6, 0, 100) },
            { MirAction.AttackRange2, new Frame(800, 6, 0, 100) },
            { MirAction.AttackRange3, new Frame(800, 6, 0, 100) },
