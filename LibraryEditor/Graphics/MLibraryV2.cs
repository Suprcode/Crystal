...
namespace LibraryEditor.Graphics {
    ...
    public sealed class MLibraryV2 {
        ...
        public void Initialize() {
            ...
            if(CurrentVersion < 2) {
                MessageBox.Show(
                    ...
                    CurrentVersion.ToString() + ".", "Failed to open", MessageBoxButtons.OK, MessageBoxIcon.Error,
        ...
        public void Save() {
            ...
            int frameSeek = (int)stream.Length + offSet;
            ...
            foreach(MirAction action in Frames.Keys) {
        ...
        public void AddImage(Bitmap image, short x, short y, bool removeBlack = true) {
            MImage mImage = new(image, removeBlack) { X = x, Y = y };
        ...
        public void AddImage(Bitmap image, Bitmap maskImage, short x, short y, bool removeBlack = true) {
            MImage mImage = new(image, maskImage, removeBlack) { X = x, Y = y };
        ...
        public sealed class MImage {
            ...
            public static byte[] Compress(byte[] raw) {
                using(MemoryStream memory = new()) {
                    using(GZipStream gzip = new(memory,
            ...
            public void CreatePreview() {
                ...
                using(System.Drawing.Graphics g = System.Drawing.Graphics.FromImage(Preview)) {
                    ...
                    g.DrawImage(Image, new Rectangle((64 - w) / 2, (64 - h) / 2, w, h),
