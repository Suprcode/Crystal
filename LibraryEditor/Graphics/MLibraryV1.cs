    ...
    public sealed class MLibraryV1 {
        ...
        public void ToMLibrary() {
            ...
            MLibraryV2 library = new(fileName)
                { Images = new List<MLibraryV2.MImage>(), IndexList = new List<int>(), Count = Images.Count };
            //library.Save();
                ...
                Parallel.For(0, Images.Count, options, i => {
                    ...
                    if(image.HasMask) {
                        library.Images[i] = new MLibraryV2.MImage(image.Image, image.MaskImage) {
                            ...
                            Shadow = image.Shadow, MaskX = image.X, MaskY = image.Y
                        };
                    } else {
        ...
        public void AddImage(Bitmap image, short x, short y) {
            MImage mImage = new(image) { X = x, Y = y };
