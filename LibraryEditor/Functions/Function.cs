...
namespace LibraryEditor.Functions {
    internal class Function {
        ...
        public static Bitmap combineIMG(string image, string shadow, int[] imageOffsets, int[] shadowOffsets,
                                        int dimension = 500) {
            Bitmap finalImage = new(dimension, dimension);
            ...
            using(System.Drawing.Graphics g = System.Drawing.Graphics.FromImage(finalImage)) {
                ...
                Bitmap shadowImage = new(shadow);

                g.DrawImage(shadowImage,
                    new Rectangle(shadowOffsets[0] + center, shadowOffsets[1] + center, shadowImage.Width,
                        shadowImage.Height));
            }
            ...
            using(System.Drawing.Graphics gr = System.Drawing.Graphics.FromImage(finalImage)) {
                Bitmap mobImage = new(image);
                mobImage.MakeTransparent(Color.Black);

                gr.DrawImage(mobImage,
                    new Rectangle(imageOffsets[0] + center, imageOffsets[1] + center, mobImage.Width, mobImage.Height));
            }
        ...
        public static Bitmap Crop(Bitmap bmp) {
            ...
            try {
                ...
                throw new Exception(
                    string.Format("Values are topmost={0} btm={1} left={2} right={3}", topmost, bottommost, leftmost,
                        rightmost),
                    ex);
            }
        }
        ...
        public static Bitmap ChangeColorBitLock(Bitmap scrBitmap) {
            ...
            LockBitmap lockBitmap = new(scrBitmap);
            lockBitmap.LockBits();
        ...
        public static Bitmap Mir3StyleShadow(Color colour, Image Path) {
            ...
            Bitmap Temp = new(tempWidth + (tempHeight / 2), tempHeight);
